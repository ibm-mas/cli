...
IBM Maximo Application Suite v9.0.16
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- migrate to SPS (90x) (#4226)
- added local login cache values 90x (#4201)
- Fix for Labels & update of Graphite to v2.13.636 (#4230)
- Add optional parameter 'addonIdentifier' to GenericAddon (#4235)
- Fix lint error 90x (#4265)
