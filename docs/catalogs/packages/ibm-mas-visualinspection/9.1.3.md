...
Maximo Visual Inspection v9.1.3
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Fix kyverno policy for taskanalysis workload (#805)
- Fix kyverno policy for model conversion workload (#809)
- Remove the old audit logger (#814)
- Fix model-conversion failure due to emptyDir exceeding the limit (#817)
