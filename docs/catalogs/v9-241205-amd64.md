...
<table>
  ...
  <tr><td>Tag</td><td>v9-241205-amd64</tr></tr>
  <tr><td>Digest</td><td>sha256:55227c26c1ba527289d9b017ba623ed501857bf6762cf07d46423cac837d4767</tr></tr>
</table>
...
- New **MAS 9.1 feature channels** for Core, Manage, Optimizer, and Visual Inspection offering early access to some of the new features that will be included in the upcoming 9.1 release next year
- **Security updates and bug fixes**
    ...
    - IBM Maximo Assist v8.8, v8.7, v9.0, v9.1
...
Manual Installation
-------------------------------------------------------------------------------
`oc apply -f https://raw.githubusercontent.com/ibm-mas/cli/master/catalogs/v9-241205-amd64.yaml`
...
spec:
  displayName: IBM Maximo Operators (v9-241205-amd64)
  publisher: IBM
  description: Static Catalog Source for IBM Maximo Application Suite
  sourceType: grpc
  image: icr.io/cpopen/ibm-maximo-operator-catalog@sha256:55227c26c1ba527289d9b017ba623ed501857bf6762cf07d46423cac837d4767
  priority: 90
```
...
|--------------------------|-------------------|---------------|-------------------------------------------------------------------------------------|
| ibm-mas                  | 9.0.x             | 9.1.x-issue-MASCORE-5711 | [9.1.0-pre.stable-7051](packages/ibm-mas/9.1.0-pre.stable-7051.md)                  |
|                          |                   | 9.0.x         | [9.0.6](packages/ibm-mas/9.0.6.md)                                                  |
|                          |                   | 8.11.x        | [8.11.17](packages/ibm-mas/8.11.17.md)                                              |
|                          |                   | 8.10.x        | [8.10.20](packages/ibm-mas/8.10.20.md)                                              |
| ibm-mas-aibroker         | 9.0.x             | 9.0.x         | [9.0.4](packages/ibm-mas-aibroker/9.0.4.md)                                         |
| ibm-mas-arcgis           | 9.0.x             | 9.0.x         | [9.0.0](packages/ibm-mas-arcgis/9.0.0.md)                                           |
| ibm-mas-assist           | 9.0.x             | 9.0.x         | [9.0.3](packages/ibm-mas-assist/9.0.3.md)                                           |
...
| ibm-mas-manage           | 9.0.x             | 9.1.x-issue-MASCORE-5711 | [9.1.0-pre.stable-8949](packages/ibm-mas-manage/9.1.0-pre.stable-8949.md)           |
|                          |                   | 9.0.x         | [9.0.7](packages/ibm-mas-manage/9.0.7.md)                                           |
|                          |                   | 8.7.x         | [8.7.14](packages/ibm-mas-manage/8.7.14.md)                                         |
|                          |                   | 8.6.x         | [8.6.20](packages/ibm-mas-manage/8.6.20.md)                                         |
...
| ibm-mas-optimizer        | 9.0.x             | 9.1.x-issue-MASCORE-5711 | [9.1.0-pre.stable-1504](packages/ibm-mas-optimizer/9.1.0-pre.stable-1504.md)        |
|                          |                   | 9.0.x         | [9.0.5](packages/ibm-mas-optimizer/9.0.5.md)                                        |
|                          |                   | 8.5.x         | [8.5.11](packages/ibm-mas-optimizer/8.5.11.md)                                      |
|                          |                   | 8.4.x         | [8.4.12](packages/ibm-mas-optimizer/8.4.12.md)                                      |
| ibm-mas-predict          | 9.0.x             | 9.0.x         | [9.0.3](packages/ibm-mas-predict/9.0.3.md)                                          |
|                          |                   | 8.9.x         | [8.9.6](packages/ibm-mas-predict/8.9.6.md)                                          |
|                          |                   | 8.8.x         | [8.8.4](packages/ibm-mas-predict/8.8.4.md)                                          |
| ibm-mas-visualinspection | 9.0.x             | 9.1.x-issue-MASCORE-5711 | [9.1.0-pre.stable-1994](packages/ibm-mas-visualinspection/9.1.0-pre.stable-1994.md) |
|                          |                   | 9.0.x         | [9.0.5](packages/ibm-mas-visualinspection/9.0.5.md)                                 |
|                          |                   | 8.9.x         | [8.9.8](packages/ibm-mas-visualinspection/8.9.8.md)                                 |
|                          |                   | 8.8.x         | [8.8.4](packages/ibm-mas-visualinspection/8.8.4.md)                                 |

### IBM Utilities
| Package             | Default Channel   | Channel   | Latest Version                                   |
|---------------------|-------------------|-----------|--------------------------------------------------|
| ibm-data-dictionary | 1.1.x             | 1.1.x     | [1.1.13](packages/ibm-data-dictionary/1.1.13.md) |
...
| ibm-cert-manager-operator           | v3.23             | v4.2         | [4.2.10](packages/ibm-cert-manager-operator/4.2.10.md)             |
...
|                                     |                   | v4.6         | [4.6.8](packages/ibm-common-service-operator/4.6.8.md)             |
...
| ibm-commonui-operator-app           | v3.23             | v4.5         | [4.5.2](packages/ibm-commonui-operator-app/4.5.2.md)               |
|                                     |                   | v4.4         | [4.4.7](packages/ibm-commonui-operator-app/4.4.7.md)               |
...
| ibm-licensing-operator-app          | v3.23             | v4.2         | [4.2.10](packages/ibm-licensing-operator-app/4.2.10.md)            |
...
| ibm-namespace-scope-operator        | v3.23             | v4.2         | [4.2.10](packages/ibm-namespace-scope-operator/4.2.10.md)          |
...
| ibm-odlm                            | v3.23             | v4.3         | [4.3.7](packages/ibm-odlm/4.3.7.md)                                |
...
| cpd-platform-operator         | v6.0              | v6.0      | [6.0.3](packages/cpd-platform-operator/6.0.3.md)            |
...
| ibm-ca-operator               | v26.3             | v4.0      | [4.0.8](packages/ibm-ca-operator/4.0.8.md)                  |
...
| ibm-cpd-ccs                   | v9.3              | v9.3      | [9.3.0](packages/ibm-cpd-ccs/9.3.0.md)                      |
...
| ibm-cpd-datarefinery          | v9.3              | v9.3      | [9.3.0](packages/ibm-cpd-datarefinery/9.3.0.md)             |
...
| ibm-cpd-wml-operator          | v6.3              | v6.3      | [6.3.0](packages/ibm-cpd-wml-operator/6.3.0.md)             |
...
| ibm-cpd-wos                   | v6.3              | v6.3      | [6.3.0](packages/ibm-cpd-wos/6.3.0.md)                      |
...
| ibm-cpd-ws-runtimes           | v9.3              | v9.3      | [9.3.0](packages/ibm-cpd-ws-runtimes/9.3.0.md)              |
...
| ibm-cpd-wsl                   | v9.3              | v9.3      | [9.3.0](packages/ibm-cpd-wsl/9.3.0.md)                      |
...
| ibm-elasticsearch-operator    | v1.1              | v1.1      | [1.1.2346](packages/ibm-elasticsearch-operator/1.1.2346.md) |
| ibm-etcd-operator             | v1.0              | v1.0      | [1.0.32](packages/ibm-etcd-operator/1.0.32.md)              |
| ibm-iam-operator              | v3.23             | v4.8      | [4.8.0](packages/ibm-iam-operator/4.8.0.md)                 |
|                               |                   | v4.7      | [4.7.0](packages/ibm-iam-operator/4.7.0.md)                 |
|                               |                   | v4.6      | [4.6.0](packages/ibm-iam-operator/4.6.0.md)                 |
|                               |                   | v4.5      | [4.5.7](packages/ibm-iam-operator/4.5.7.md)                 |
...
| ibm-rabbitmq-operator         | v1.0              | v1.0      | [1.0.32](packages/ibm-rabbitmq-operator/1.0.32.md)          |
| ibm-watson-discovery-operator | v8.3              | v8.3      | [8.3.0](packages/ibm-watson-discovery-operator/8.3.0.md)    |
...
| ibm-appconnect   | v12.5             | v9.2      | 9.2.1                                         |
|                  |                   | v9.1      | 9.1.0                                         |
|                  |                   | v9.0      | 9.0.0                                         |
|                  |                   | v8.2      | 8.2.1                                         |
|                  |                   | v8.1      | 8.1.0                                         |
