...
IBM Maximo Manage v8.7.17
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- MASISMIG-61379 - Update buildtag pattern into CRD (#2190)
- update maxloader ref to current (87x) (#2196)
- is patch 8.7.17 (#2191)
- Changes for Utilities 8.1.15 (#2205)
- Health 8.9.13 March 2025 release (#2204)
- Initial DCUT changes for march 8.7.x release (#2207)
- Correction to the schema of ManageWorkspace CRD: 87x (#2202)
