...
IBM Maximo Manage v8.7.18
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- added arch type amd64 for monitoring openshift (#2214)
- Update BDI application image to latest version (#2229)
- testPrometheusServerLevelMetrics is failing in the fvt87x pipeline (#2226)
- is patch 8.7.18 (#2230)
- Utilities 8.1.16 changes (#2234)
- update secrets.baseline (#2248)
- Health 8.9.14 April 2025 release (#2255)
- fix the health compatibility with Manage issue - MAXMF-1948 (#2258)
