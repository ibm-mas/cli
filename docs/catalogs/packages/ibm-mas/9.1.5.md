...
IBM Maximo Application Suite v9.1.5
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- migrate to SPS (91x) (#4225)
- Fix for Labels & update of Graphite to v3.1.606 (#4246)
- Add optional parameter 'addonIdentifier' to GenericAddon (#4233)
- Make sure the user is resynced in Manage when the forceTokenChange flag is flipped as this flag will be added to the IDP table in Manage (91x) (#4220)
- backport vegm to 91x (#4262)
