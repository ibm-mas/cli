...
IBM Maximo Optimizer v9.0.26
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- MSO-2742 (9.0.x) - CVEs fixes - pyasn1-0.6.3-py3-none-any.whl (#503)
- MSO-2768 (9.0.x) - cryptography-46.0.7-cp311-abi3-manylinux_2_34_x86_64.whl (#513)
- MSO-2778 - Remove unused query-string dependency breaking decode-uri-component 0.5.0 (#520)
