IBM Maximo Operator Catalog v9 (250901)
===============================================================================
...
<table>
  ...
  <tr><td>Tag</td><td>v9-250901-amd64</tr></tr>
...
Manual Installation
-------------------------------------------------------------------------------
`oc apply -f https://raw.githubusercontent.com/ibm-mas/cli/master/catalogs/v9-250901-amd64.yaml`
...
spec:
  displayName: IBM Maximo Operators (v9-250901-amd64)
  publisher: IBM
