...
IBM Maximo IoT v9.1.10
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- 91x Update operators.yaml with latest edgeconfig image (#1101)
- Updating mbgx to 5.0.61 (#1149)
- Update operators.yaml to include latest version of edgeconfig (#1156)
