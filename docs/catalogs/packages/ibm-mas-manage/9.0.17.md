...
IBM Maximo Manage v9.0.17
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- 90x Fix for DT448574 [MASISMIG-67637] (#2756)
- This update applies new patch versions to all operand images (#2771)
- Manage APP CRD is missing spec components - Patch 9.0.x DT448611 (#2775)
- Adding final images for 9.0.17 Sep patch (#2807)
