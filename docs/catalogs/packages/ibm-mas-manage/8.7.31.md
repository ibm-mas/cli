...
IBM Maximo Manage v8.7.31
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Updated the supported version matrix added 8.7.30 and 8.7.31 (#3289)
- Updated the ansible-operator version to 9.1.11 and scripts to support latest K8s.client ansible collection (#3325)
- DT462849 - BDI pod logs contain verbose garbage collection output (8.7.x) (#3348)
- Updated the ansible-operator version from 9.1.11 to 9.1.15 (#3369)
