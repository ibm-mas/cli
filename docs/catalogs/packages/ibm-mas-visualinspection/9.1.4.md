...
Maximo Visual Inspection v9.1.4
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Fix kyverno policy for video workload (#816)
- Fix kyverno policy for operator (#823)
- Increase tmp-nginx sizeLimit for videoms (#838)
- Increase all tmp folders sizeLimit for videoms (#841)
- Fix kyverno policy for ui workload (#848)
- Update ubi8/ubi-minimal used by task-pvc to latest (#852)
- Finetune dataset-service probes/jvm to handle large GC/OOM (#855)
- Add back pvc mount to ui pod (#857)
- Implement FIPS compliance and improve cryptographic security (#844)
- Migrate to Tekton SPS build (#790)
- add FIPS support to operator - probe and configMap (#872)
- Fix ibm-require-ro-rootfs kyverno policy for service workloads (#871)
- [MASMVI-2746] Flag FIPS mode enabled/disabled in ConfigMap (#874)
- Increase tmp folder liberty-cache for service pod (#879)
- Fix mas-require-run-as-nonroot policy for task-pvc (#881)
