...
IBM Maximo IoT v9.0.12
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- commit to pick up operators with icr fixes (#758)
- Operand Container image updates (#763)
- Update State operator with latest state-updater (#770)
