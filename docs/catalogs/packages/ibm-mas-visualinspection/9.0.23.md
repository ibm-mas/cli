...
Maximo Visual Inspection v9.0.23
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- replace kustomize install script with direct download to avoid GitHub API rate limiting (#1417)
- Update the ubi9 tag for resource file - 9.0.x (#1426)
