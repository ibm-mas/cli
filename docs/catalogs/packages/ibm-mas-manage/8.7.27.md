...
IBM Maximo Manage v8.7.27
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Moving to Python version used by SPS runtime.. (#2981)
- Initial changes for the Dec 2025 patch release (#3004)
- updated operand version for 87x to 2611 (#3014)
- updated manageadmin image 8.7.27_2827 build (#3025)
- update ubi-python to latest(87x) (#3023)
