...
IBM Maximo Manage v9.0.9
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Add addon placeholders for 9.0.9 release (#2155)
- fix to MASCORE-5013 (#2156)
- Health version update 9.0.68 (#2171)
- Manual image updates - 9.0.9 patch (#2175)
- manual image version update for hse and oilandgas (#2178)
- manual update manage base 9.0.81 (#2180)
- MAXMF-1426 - onlineUpgrade causes bundle server restart during online phase on second update (#2172)
- add final image for 9.0.9 release (#2182)
