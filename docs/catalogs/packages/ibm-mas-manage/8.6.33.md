...
IBM Maximo Manage v8.6.33
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Moving to Python version used by SPS runtime.. (#2982)
- update ubi-python to latest(86x) (#3024)
- Updated the final manageadmin image for Dec patch (#3053)
