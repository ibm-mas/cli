...
| operator.ibm.com                         | authentications                          | create, delete, get, list, patch, update, use, watch                             |
| ""                                       | configmaps                               | get, list, use                                                                   |
| ""                                       | namespaces                               | get, list, use, watch                                                            |
| ""                                       | endpoints                                | get, list, use, watch                                                            |
| ""                                       | services                                 | get, list, use, watch                                                            |
| ""                                       | nodes                                    | get, list, use, watch                                                            |
| ""                                       | persistentvolumes                        | create, delete, get, list, patch, update, use, watch                             |
| apps                                     | deployments                              | get, list, watch                                                                 |
| apiextensions.k8s.io                     | customresourcedefinitions                | create, delete, get, list, patch, update, watch                                  |
| cluster.ibm-cpd-mcscheduler.ibm.com      | physicallocationsets                     | create, delete, get, list, patch, update, watch                                  |
| cluster.ibm-cpd-mcscheduler.ibm.com      | distributionrules                        | create, delete, get, list, patch, update, watch                                  |
| cluster.ibm-cpd-mcscheduler.ibm.com      | addondistributionrulescores              | create, delete, get, list, patch, update, watch                                  |
| cluster.ibm-cpd-mcscheduler.ibm.com      | distributionruledecision                 | create, delete, get, list, patch, update, watch                                  |
| cluster.ibm-cpd-mcscheduler.ibm.com      | distributionruledecisions                | create, delete, get, list, patch, update, watch                                  |
| cluster.ibm-cpd-mcscheduler.ibm.com      | distributionruledecisions/status         | create, delete, get, list, patch, update, watch                                  |
| cluster.ibm-cpd-mcscheduler.ibm.com      | distributionrules/finalizers             | create, delete, get, list, patch, update, watch                                  |
| cluster.ibm-cpd-mcscheduler.ibm.com      | distributionrules/status                 | create, delete, get, list, patch, update, watch                                  |
| cluster.ibm-cpd-mcscheduler.ibm.com      | physicallocations                        | create, delete, get, list, patch, update, watch                                  |
| cluster.ibm-cpd-mcscheduler.ibm.com      | physicallocationsetbindings              | create, delete, get, list, patch, update, watch                                  |
| cluster.ibm-cpd-mcscheduler.ibm.com      | physicallocations/status                 | create, delete, get, list, patch, update, watch                                  |
| coordination.k8s.io                      | leases                                   | create, delete, get, list, patch, update, watch                                  |
| events.k8s.io                            | events                                   | create, delete, get, list, patch, update, watch                                  |
| security.openshift.io                    | securitycontextconstraints               | use                                                                              |
| work.ibm-cpd-mcscheduler.ibm.com         | remotecrs                                | create, delete, deletecollection, execute-as, get, list, patch, update, watch    |
| work.ibm-cpd-mcscheduler.ibm.com         | remotekuberestemplates                   | create, delete, deletecollection, execute-as, get, list, patch, update, watch    |
| work.ibm-cpd-mcscheduler.ibm.com         | remotekuberestemplates/status            | create, delete, deletecollection, execute-as, get, list, patch, update, watch    |
| work.ibm-cpd-mcscheduler.ibm.com         | remotekuberestemplates/finalizers        | create, delete, deletecollection, execute-as, get, list, patch, update, watch    |
| authorization.k8s.io                     | subjectaccessreviews                     | create, get, list, patch, update, watch                                          |
...
| ""                                       | pods/eviction                            | create, delete, deletecollection, get, list, patch, update, watch                |
...
| ""                                       | verticalpodautoscalers                   | create, delete, deletecollection, get, list, patch, update, watch                |
...
| batch                                    | pods/eviction                            | create, delete, deletecollection, get, list, patch, update, watch                |
...
| batch                                    | replicationcontrollers                   | create, delete, deletecollection, get, list, patch, update, watch                |
...
| batch                                    | persistentvolumes                        | create, delete, deletecollection, get, list, patch, update, watch                |
...
| batch                                    | verticalpodautoscalers                   | create, delete, deletecollection, get, list, patch, update, watch                |
...
| batch                                    | processedtemplates                       | create, delete, deletecollection, get, list, patch, update, watch                |
...
| extensions                               | pods/eviction                            | create, delete, deletecollection, get, list, patch, update, watch                |
...
| extensions                               | replicationcontrollers                   | create, delete, deletecollection, get, list, patch, update, watch                |
...
| extensions                               | persistentvolumes                        | create, delete, deletecollection, get, list, patch, update, watch                |
...
| extensions                               | verticalpodautoscalers                   | create, delete, deletecollection, get, list, patch, update, watch                |
...
| extensions                               | processedtemplates                       | create, delete, deletecollection, get, list, patch, update, watch                |
...
| apps                                     | pods/eviction                            | create, delete, deletecollection, get, list, patch, update, watch                |
...
| apps                                     | replicationcontrollers                   | create, delete, deletecollection, get, list, patch, update, watch                |
...
| apps                                     | persistentvolumes                        | create, delete, deletecollection, get, list, patch, update, watch                |
...
| apps                                     | verticalpodautoscalers                   | create, delete, deletecollection, get, list, patch, update, watch                |
...
| apps                                     | processedtemplates                       | create, delete, deletecollection, get, list, patch, update, watch                |
...
| policy                                   | pods/eviction                            | create, delete, deletecollection, get, list, patch, update, watch                |
...
| policy                                   | replicationcontrollers                   | create, delete, deletecollection, get, list, patch, update, watch                |
...
| policy                                   | persistentvolumes                        | create, delete, deletecollection, get, list, patch, update, watch                |
...
| policy                                   | verticalpodautoscalers                   | create, delete, deletecollection, get, list, patch, update, watch                |
...
| policy                                   | processedtemplates                       | create, delete, deletecollection, get, list, patch, update, watch                |
...
| rbac.authorization.k8s.io                | pods/eviction                            | create, delete, deletecollection, get, list, patch, update, watch                |
...
| rbac.authorization.k8s.io                | replicationcontrollers                   | create, delete, deletecollection, get, list, patch, update, watch                |
...
| rbac.authorization.k8s.io                | persistentvolumes                        | create, delete, deletecollection, get, list, patch, update, watch                |
...
| rbac.authorization.k8s.io                | verticalpodautoscalers                   | create, delete, deletecollection, get, list, patch, update, watch                |
...
| rbac.authorization.k8s.io                | processedtemplates                       | create, delete, deletecollection, get, list, patch, update, watch                |
...
| autoscaling                              | pods/eviction                            | create, delete, deletecollection, get, list, patch, update, watch                |
...
| autoscaling                              | replicationcontrollers                   | create, delete, deletecollection, get, list, patch, update, watch                |
...
| autoscaling                              | persistentvolumes                        | create, delete, deletecollection, get, list, patch, update, watch                |
...
| autoscaling                              | verticalpodautoscalers                   | create, delete, deletecollection, get, list, patch, update, watch                |
...
| autoscaling                              | processedtemplates                       | create, delete, deletecollection, get, list, patch, update, watch                |
...
| route.openshift.io                       | pods/eviction                            | create, delete, deletecollection, get, list, patch, update, watch                |
...
| route.openshift.io                       | replicationcontrollers                   | create, delete, deletecollection, get, list, patch, update, watch                |
...
| route.openshift.io                       | persistentvolumes                        | create, delete, deletecollection, get, list, patch, update, watch                |
...
| route.openshift.io                       | verticalpodautoscalers                   | create, delete, deletecollection, get, list, patch, update, watch                |
...
| route.openshift.io                       | processedtemplates                       | create, delete, deletecollection, get, list, patch, update, watch                |
...
| authorization.openshift.io               | pods/eviction                            | create, delete, deletecollection, get, list, patch, update, watch                |
...
| authorization.openshift.io               | replicationcontrollers                   | create, delete, deletecollection, get, list, patch, update, watch                |
...
| authorization.openshift.io               | persistentvolumes                        | create, delete, deletecollection, get, list, patch, update, watch                |
...
| authorization.openshift.io               | verticalpodautoscalers                   | create, delete, deletecollection, get, list, patch, update, watch                |
...
| authorization.openshift.io               | processedtemplates                       | create, delete, deletecollection, get, list, patch, update, watch                |
...
| networking.k8s.io                        | pods/eviction                            | create, delete, deletecollection, get, list, patch, update, watch                |
...
| networking.k8s.io                        | replicationcontrollers                   | create, delete, deletecollection, get, list, patch, update, watch                |
...
| networking.k8s.io                        | persistentvolumes                        | create, delete, deletecollection, get, list, patch, update, watch                |
...
| networking.k8s.io                        | verticalpodautoscalers                   | create, delete, deletecollection, get, list, patch, update, watch                |
...
| networking.k8s.io                        | networkpolicies                          | create, delete, deletecollection, get, list, patch, update, use, watch           |
...
| networking.k8s.io                        | processedtemplates                       | create, delete, deletecollection, get, list, patch, update, watch                |
...
| metrics.k8s.io                           | pods/eviction                            | create, delete, deletecollection, get, list, patch, update, watch                |
...
| metrics.k8s.io                           | replicationcontrollers                   | create, delete, deletecollection, get, list, patch, update, watch                |
...
| metrics.k8s.io                           | persistentvolumes                        | create, delete, deletecollection, get, list, patch, update, watch                |
...
| metrics.k8s.io                           | verticalpodautoscalers                   | create, delete, deletecollection, get, list, patch, update, watch                |
...
| metrics.k8s.io                           | processedtemplates                       | create, delete, deletecollection, get, list, patch, update, watch                |
...
| project.openshift.io                     | pods/eviction                            | create, delete, deletecollection, get, list, patch, update, watch                |
...
| project.openshift.io                     | replicationcontrollers                   | create, delete, deletecollection, get, list, patch, update, watch                |
...
| project.openshift.io                     | persistentvolumes                        | create, delete, deletecollection, get, list, patch, update, watch                |
...
| project.openshift.io                     | verticalpodautoscalers                   | create, delete, deletecollection, get, list, patch, update, watch                |
...
| project.openshift.io                     | processedtemplates                       | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | pods                                     | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | pods/log                                 | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | pods/eviction                            | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | poddisruptionbudgets                     | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | projects                                 | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | secrets                                  | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | jobs                                     | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | configmaps                               | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | deployments                              | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | deployments/scale                        | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | daemonsets                               | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | statefulsets                             | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | statefulsets/scale                       | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | replicasets                              | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | replicationcontrollers                   | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | services                                 | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | services/finalizers                      | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | persistentvolumes                        | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | persistentvolumeclaims                   | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | cronjobs                                 | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | pods/exec                                | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | pods/portforward                         | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | serviceaccounts                          | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | namespaces                               | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | roles                                    | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | rolebindings                             | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | horizontalpodautoscalers                 | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | verticalpodautoscalers                   | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | routes                                   | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | routes/custom-host                       | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | ingresses                                | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | endpoints                                | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | cronjob                                  | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | networkpolicies                          | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | events                                   | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | jobs/status                              | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | pods/status                              | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | resourcequotas                           | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | resourcequotas/status                    | create, delete, deletecollection, get, list, patch, update, watch                |
| template.openshift.io                    | processedtemplates                       | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | pods                                     | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | pods/log                                 | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | pods/eviction                            | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | poddisruptionbudgets                     | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | projects                                 | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | secrets                                  | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | jobs                                     | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | configmaps                               | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | deployments                              | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | deployments/scale                        | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | daemonsets                               | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | statefulsets                             | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | statefulsets/scale                       | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | replicasets                              | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | replicationcontrollers                   | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | services                                 | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | services/finalizers                      | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | persistentvolumes                        | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | persistentvolumeclaims                   | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | cronjobs                                 | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | pods/exec                                | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | pods/portforward                         | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | serviceaccounts                          | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | namespaces                               | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | roles                                    | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | rolebindings                             | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | horizontalpodautoscalers                 | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | verticalpodautoscalers                   | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | routes                                   | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | routes/custom-host                       | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | ingresses                                | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | endpoints                                | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | cronjob                                  | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | networkpolicies                          | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | events                                   | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | jobs/status                              | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | pods/status                              | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | resourcequotas                           | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | resourcequotas/status                    | create, delete, deletecollection, get, list, patch, update, watch                |
| autoscaling.k8s.io                       | processedtemplates                       | create, delete, deletecollection, get, list, patch, update, watch                |
...
| cpd.ibm.com                              | ibmcpd                                   | create, get, list, patch, update, watch                                          |
| cpd.ibm.com                              | ibmcpds                                  | create, get, list, patch, update, watch                                          |
...
| zen.cpd.ibm.com                          | zenservice                               | create, delete, get, list, patch, update, watch                                  |
| zen.cpd.ibm.com                          | zenservices                              | create, delete, get, list, patch, update, watch                                  |
| zen.cpd.ibm.com                          | zenservice/status                        | create, delete, get, list, patch, update, watch                                  |
...
| zen.cpd.ibm.com                          | zenextension/finalizers                  | create, delete, get, list, patch, update, watch                                  |
| zen.cpd.ibm.com                          | zenextensions/finalizers                 | create, delete, get, list, patch, update, watch                                  |
| ibm.com                                  | paralleljob                              | get, list                                                                        |
| ibm.com                                  | paralleljobs                             | get, list                                                                        |
| ibm.com                                  | paralleljob/status                       | get, list                                                                        |
| ibm.com                                  | paralleljobs/status                      | get, list                                                                        |
| ibm.com                                  | resourceplans                            | create, delete, deletecollection, get, list, patch, update, watch                |
| ibm.com                                  | resourcematches                          | create, delete, deletecollection, get, list, patch, update, watch                |
| tekton.dev                               | taskrun                                  | get, list                                                                        |
| tekton.dev                               | taskruns                                 | get, list                                                                        |
| tekton.dev                               | taskrun/status                           | get, list                                                                        |
| tekton.dev                               | taskruns/status                          | get, list                                                                        |
| db2u.databases.ibm.com                   | db2uengines                              | get, list, patch, update                                                         |
...
| operator.ibm.com                         | operandrequest                           | create, delete, get, list, patch, update, use, watch                             |
| operator.ibm.com                         | operandrequests                          | create, delete, get, list, patch, update, use, watch                             |
| operator.ibm.com                         | operandbindinfo                          | create, delete, get, list, patch, update, use, watch                             |
...
| operators.coreos.com                     | operatorconditions                       | get, list, patch, update, watch                                                  |
| operators.coreos.com                     | operatorconditions/status                | get, list, patch, update, watch                                                  |
...
| watsonxaiifm.cpd.ibm.com                 | watsonxaiifm                             | get, list, patch, update, watch                                                  |
