...
IBM Maximo Optimizer v9.1.15
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- MSO-2742 (9.1.x) - CVEs fixes - pyasn1-0.6.3-py3-none-any.whl (#502)
- MSO-2768 (9.1.x) - cryptography-46.0.7-cp311-abi3-manylinux_2_34_x86_64.whl (#512)
