...
IBM Maximo Predict v8.8.5
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- update predictapi: 5.8.1 in images.yml (#368)
-  Backport fix for recocile 4 times issue to predict 8.8.x #14863 (#380)
- fix health compatibility (#387)
