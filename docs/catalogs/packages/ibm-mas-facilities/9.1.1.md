...
IBM Maximo Real Estate and Facilities v9.1.1
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Added sort filter in GS1 and US1 env vars for DWF Agents (#197)
- Added nopriv serviceAccount for workloads (#198)
- Added ipFamilies and ipFamilyPolicy in the operator (#204)
