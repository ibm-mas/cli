...
IBM Maximo Application Suite v8.10.33
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Fix port enumeration in push notification (#4440)
- Add HSTS header to coreidp to fix vulnerability (#4525)
- update mas util to 7.27.2: 810x (#4535)
- upgrade ansible-operator to latest (#4522)
- Add smtp ouath2 for outgoing emails 8.10.x [MASCORE-10041] (#4573)
