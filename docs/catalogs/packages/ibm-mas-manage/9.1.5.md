...
IBM Maximo Manage v9.1.5
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Added missing fields into crds for podTemplates (9.1.x) (#2817)
- mxe system properties added into non system properties secret fix (9.1.x) (#2813)
- add missing resource config and probes (9.1.x) (#2839)
- Read-Only Root file system (ibm-require-ro-rootfs) for manageApp cr pods (9.1.x) (#2809)
- Expose system information as environment variable (9.1.x) (#2795)
- AIP Optimization extension operator (9.1.x) (#2682)
- MAXVM-116 backported vegm to 91x (#2859)
