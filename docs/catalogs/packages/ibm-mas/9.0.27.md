...
IBM Maximo Application Suite v9.0.27
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Reduce CPU throttling in entitymgr-mongocfg (maint90xdev) (#5012)
- mobileapi update to update navigator and it's graphite version (#5136)
- updated coreapi version for 90x (#5152)
- Update mobileapi version for graphite update (#5182)
- Update suite image digests for versions 9.0.26, 9.1.17, 9.1.18 (#5143)
- sendmail pod restarting every few minutes (#5166)
- DT473203 - Fix OIDC client registration job stuck in deletion with finalizers - 9.0.x (#5190)
