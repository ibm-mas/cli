...
IBM Maximo Application Suite v9.1.21
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- add limited plan for optimizer saas premium edition - 91x (#5280)
- MAXMA-2462 add value metrics for optimizer 9.1.x (#5282)
- Update suite image digests for versions 9.1.x (#5284)
- Redirect to the value of mas-redirect-uri after a forced logout because of an authentication error caused by the IDP (#5294)
- update operands - maint91 (#5299)
- App config image version update for August patch - MAS 91 (#5327)
- update ansible-operator (#5335)
- Remove Simulated UDS (SUDS) from BAS Cfg operator(9.1.x) (#5366)
- homepage updated to 10.7.39 to fix pod restart loop intermittent issue (#5418)
