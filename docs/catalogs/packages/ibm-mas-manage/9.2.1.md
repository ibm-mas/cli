...
IBM Maximo Manage v9.2.1
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- add subscription role for coreapi, internalapi and fix the molecule (#3803)
- Fixed AIP uninstall job issue (#3811)
- final image update for july release (#3844)
