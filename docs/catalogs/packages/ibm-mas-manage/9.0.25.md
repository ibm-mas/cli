...
IBM Maximo Manage v9.0.25
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- set mxe.mail.oauth.clientName sys property from operator: 90x (#3488)
- Add ephemeralStorageClassName in ManageWorkspace CRD (9.0.x) (#3504)
- Add disableMonitorAgent in ManageWorkspace CRD (9.0.x) (#3509)
- updated final operand update for apr release (#3560)
