...
What's New
-------------------------------------------------------------------------------
- **MongoDb v5 support**  Running `mas update` will automatically upgrade existing `MongoDbCommunity` instances to MongoDb version 5.  This upgrade is compatible with **all** MAS versions included in this catalog.
