...
IBM Maximo Predict v9.0.16
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- update ansible-operator to 9.3.6 (9.0.x) (#1533)
- updated urllib, idna, requests and mas-utils (9.0.x) (#1535)
- update june 90 versions (#1538)
