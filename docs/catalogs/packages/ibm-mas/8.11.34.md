...
IBM Maximo Application Suite v8.11.34
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- mobileapi update to update navigator and it's graphite version to v2.12.464 (#4807)
- Fix kafka certs 811 (#4792)
- Fix CoreIDP Molecule Test Failure - Type Mismatch in Pod Templates : 811 (#4848)
- guard against undefined config.oauthAuthentication (#4755)
- Update suite image digests for versions: 811x (#4880)
- mobileapi update to update navigator and it's graphite version (#4893)
- security fix for axios - maint811 (#4939)
- update accappoints to 3.7.186 81x (#4954)
