...
<table>
  ...
  <tr><td>Digest</td><td>sha256:0a24540abbb65155d3dfde68fe57a777aae785127ebb34a272614a06710caaa2</tr></tr>
</table>
...
- We are aware of an issue affecting entitlement for **Maximo AI Service 9.1.5**, the team are actively working on a resolution.

!!! tip
    To verify whether the Maximo AI Service entitlement issue is impacting your entitlement key run the following:

    ```
    docker login -u iamapikey -p {my-entitlement-key} cp.icr.io/cp
    docker pull cp.icr.io/cp/aiservice/ibm-aiservice-tenant:9.1.5
    ```

    If you see the following error: `denied: You are not authorized to access this resource` then the issue is not yet resolved.
...
spec:
  ...
  sourceType: grpc
  image: icr.io/cpopen/ibm-maximo-operator-catalog@sha256:0a24540abbb65155d3dfde68fe57a777aae785127ebb34a272614a06710caaa2
  priority: 90
```
...
|--------------------------|-------------------|---------------|-------------------------------------------------------|
| ibm-aiservice            | 9.1.x             | 9.1.x         | [9.1.5](packages/ibm-aiservice/9.1.5.md)              |
...
| ibm-cpd-datarefinery          | v11.0             | v9.3      | [9.3.0](packages/ibm-cpd-datarefinery/9.3.0.md)             |
