...
<table>
  ...
  <tr><td>Digest</td><td>sha256:e8e9f92476b0ac0846d546823538cc365e55058f6caab874346133c04316e749</tr></tr> 
  <!-- ^^^^^ tbc -->
</table>
...
What's New
-------------------------------------------------------------------------------
- **Openshift 4.16 support** Openshift Container Platform 4.16 support has been added.
- **Cloud Pak For Data 5.0 support** Running 'mas update' will automatically upgrade existing Cloud Pak For Data instances to version 5.0.0 this requires Cloud Pak For Data to be on version 4.8.0 or above. If Cloud Pak For Data is on an earlier version then an update to an intermediary catalog is required.
...
spec:
  ...
  sourceType: grpc
  image: icr.io/cpopen/ibm-maximo-operator-catalog@sha256:e8e9f92476b0ac0846d546823538cc365e55058f6caab874346133c04316e749
  priority: 90
```
