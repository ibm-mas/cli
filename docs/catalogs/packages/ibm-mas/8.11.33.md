...
IBM Maximo Application Suite v8.11.33
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- mobileapi update to update navigator and it's graphite version to v2.12.462 (#4688)
- security fix for axios, lodash, lodash-es and qs - 8.11 (#4736)
- emergency downgrade of kubernetes python MASISMIG-73418 fix dependencies 811x (#4785)
