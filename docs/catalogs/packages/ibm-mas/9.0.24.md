...
IBM Maximo Application Suite v9.0.24
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- mobileapi update to update navigator and it's graphite version to v2.13.663 (#4806)
- fix kafka certs 90x (#4794)
- Fix CoreIDP Molecule Test Failure - Type Mismatch in Pod Temp… (#4853)
- use coreidp with new mongoclient (#4820)
- guard against undefined config.oauthAuthentication (#4756)
- Update suite image digests for versions 90x (#4874)
- mobileapi update to update navigator and it's graphite version (#4894)
- Force the redeploy of scimsync liberty server when LDAP password changes for MASISMIG-73055 issue 90x (#4897)
- security fix for axios - maint 90 (#4938)
- update accapppoints: 3.10.49 90x (#4953)
