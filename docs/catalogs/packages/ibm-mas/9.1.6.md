...
IBM Maximo Application Suite v9.1.6
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Enable Replica for non-prod order also (#4290)
- Fix for Labels & update of Graphite to v3.1.610 (#4309)
- Add support for reportAdoptionMetrics flag to control collection of adoption metrics in Suite CR and BAS CFG for 9.1 (#4276)
- Email is optional in Scim V2 User APIs (91x) (#4331)
- added rdnproperty related envs for scimsync and Update certificate timeout and molecule scenario (#4332)
- Add compatibility to non-readonly mode - 9.1.x (#4342)
- mobileapi update to update navigator and it's graphite version to v3.1.616 (#4343)
- Add read-only mode - 9.1.x (#4250)
- add retry option for internalapi binding status - 9.1.x (#4352)
- Removing not used apps deprecation process to fix appConnect permission issue - 91 (#4354)
- Fix tmp folder that was not following the new tmp/writeable path - 9.1.x (#4357)
- added local login cache values for maint91x (#4359)
- Add back /tmp/mas folder as part of ansible-operator - 9.1.x (#4371)
