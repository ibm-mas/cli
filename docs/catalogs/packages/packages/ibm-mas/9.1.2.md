...
IBM Maximo Application Suite v9.1.2
================================================================================
...
- Fix for Labels & update of Graphite to v3.1.556 (#4012)
...
- upgrade coreidplogin to latest (#4088)
- Fix to include templates folder into /opt/ibm/sendmailapi folder - 9.1.x (#4094)
- Include users without email in sendmail_bulk payload (91x) (#4107)
- coreapi image version updated for 91 (#4109)
- Fix issue with commonNav ymls in coreapi build (91x) (#4112)
- MASCORE-8418 Address Kyverno policies in Core - 91x backport (#4117)
- Given correct templates path for sendmailapi templates (91x) (#4123)
- Use latest sendmailapi build to allow toAdress to be null (91x) (#4127)
