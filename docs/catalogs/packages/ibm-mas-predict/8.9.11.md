...
IBM Maximo Predict v8.9.11
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- update Settings for correct mime type based on the file extension for MAS8.11 (#1030)
- update aiexpts version (#1059)
- update release versions for predict for MAS 8.11 (#1067)
- update matrix for Core in MAS 8.11 (#1070)
- update health version for matrix for MAS 8.11 (#1071)
