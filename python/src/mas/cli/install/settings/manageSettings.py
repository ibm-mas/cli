    ...
    def _manageSettingsDatabase(self) -> None:
        ...
        if self.yesOrNo("Customize database settings"):
            ...
            if self.yesOrNo("Customize database encryption settings"):
                self.promptForString("MXE_SECURITY_CRYPTO_KEY", "mas_manage_encryptionsecret_crypto_key", isPassword=True)
                self.promptForString("MXE_SECURITY_CRYPTOX_KEY", "mas_manage_encryptionsecret_cryptox_key", isPassword=True)
                self.promptForString("MXE_SECURITY_OLD_CRYPTO_KEY", "mas_manage_encryptionsecret_old_crypto_key", isPassword=True)
                self.promptForString("MXE_SECURITY_OLD_CRYPTOX_KEY", "mas_manage_encryptionsecret_old_cryptox_key", isPassword=True)
