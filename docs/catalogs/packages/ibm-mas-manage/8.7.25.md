...
IBM Maximo Manage v8.7.25
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- mxe system properties added into non system properties secret fix (8.7.x) (#2815)
- Added missing fields into crds for podTemplates (8.7.x) (#2819)
- Updated the latest health version in supported version matrix (#2880)
