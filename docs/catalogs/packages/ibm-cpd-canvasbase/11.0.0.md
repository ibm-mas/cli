...
canvasbase Modeler Services v11.0.0
================================================================================
...
| zen.cpd.ibm.com                          | pods                                     | get, list, watch                                                                 |
| zen.cpd.ibm.com                          | pods/log                                 | get, list, watch                                                                 |
| zen.cpd.ibm.com                          | poddisruptionbudgets                     | get, list, watch                                                                 |
| zen.cpd.ibm.com                          | secrets                                  | get, list, watch                                                                 |
| zen.cpd.ibm.com                          | jobs                                     | get, list, watch                                                                 |
| zen.cpd.ibm.com                          | configmaps                               | get, list, watch                                                                 |
| zen.cpd.ibm.com                          | deployments                              | get, list, watch                                                                 |
| zen.cpd.ibm.com                          | deployments/scale                        | get, list, watch                                                                 |
| zen.cpd.ibm.com                          | deployments/finalizers                   | get, list, watch                                                                 |
| zen.cpd.ibm.com                          | daemonsets                               | get, list, watch                                                                 |
...
| canvasbase.cpd.ibm.com                   | canvasbase                               | create, delete, get, list, patch, update, watch                                  |
| canvasbase.cpd.ibm.com                   | canvasbase/spec                          | create, delete, get, list, patch, update, watch                                  |
| canvasbase.cpd.ibm.com                   | canvasbase/status                        | create, delete, get, list, patch, update, watch                                  |
| canvasbase.cpd.ibm.com                   | canvasbase/finalizers                    | create, delete, get, list, patch, update, watch                                  |
