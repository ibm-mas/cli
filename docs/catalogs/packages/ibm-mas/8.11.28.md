...
IBM Maximo Application Suite v8.11.28
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Fix for Labels & update of Graphite to v2.12.455 (#4306)
- set resources for ibm-mas manager MASCORE-6027 811x (#4320)
- mobileapi update to update navigator and it's graphite version to v2.12.456 (#4345)
