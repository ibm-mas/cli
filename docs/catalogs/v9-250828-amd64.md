...
<table>
  ...
  <tr><td>Digest</td><td>sha256:adea6ac79804698267a11806cbc93b4a4a650fb3dac6ed619d590d9d8469bda3</tr></tr>
</table>
...
Reminder
-------------------------------------------------------------------------------
- MAS 8.10 and 8.11 standard support and software updates end in 30th April 2026, to ensure you are able to continue to receive monthly security updates and bug fixes we advise all customers to begin making upgrade plans to get to MAS 9.0 if you have not already done so.
...
- Customers running Maximo Manage v8.7 with the Civil application in a disconnected environment are advised not to install the August patch
...
spec:
  ...
  sourceType: grpc
  image: icr.io/cpopen/ibm-maximo-operator-catalog@sha256:adea6ac79804698267a11806cbc93b4a4a650fb3dac6ed619d590d9d8469bda3
  priority: 90
```
