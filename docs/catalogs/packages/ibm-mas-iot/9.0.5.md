...
IBM Maximo IoT v9.0.5
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Update mas-utils to v7.18.4 (#531) (#533)
- IBMIOT-656 Update the Baseimage, Operators and Services (#535)
- IBMIOT-656 Update license files for FT (90x) (#537)
- upgrade datapower (#553)
- IBMIOT-737 Update the Baseimage, Operators and Services (#560)
- Update mbgx version to latest (#564)
- Update EDC operator (#568)
