...
IBM Maximo IoT v9.0.18
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Updated version for auth (#1009)
- 90x update edge config version to latest (#1031)
- 90x update edge config version to latest to revert django changes (#1032)
- updated mas-utils from v7.29.8 to 7.29.7 (#1087)
