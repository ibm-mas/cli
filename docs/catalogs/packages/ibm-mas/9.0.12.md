...
IBM Maximo Application Suite v9.0.12
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Update verify_jdbc.py - 90x (#3660)
- Added CRD changes for IDP status change API (#3739)
- added yq error fix on build-pem.sh for power platform (#3773)
- Fix SAML race condition (#3776)
- backport changes for genericaddon and catalog addons (#3765)
- Update Catalog for generic add-on additional VPN changes (#3762)
- Backport addons - allowlist, extensions and enhanceddr (#3780)
- set liberty version 25.0.0.2 into coreidp: 90x (#3795)
- Fix for Labels & update of Graphite to v2.13.597 for MAS90 Navigator-App (#3803)
- Add 90x prev release into rollback supported images list (90x) (#3841)
- homepage rebuild to fix arch error (#3854)
- Validate if user is active before checking credentials in the /v3/users/checkauthentication internal API (90x) (#3857)
