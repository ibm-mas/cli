...
PACKAGE_CONFIGS = [
    ...
    ("Cloud Pak for Data - Platform", "cp4d-platform", "ibm-cp-common-services", "common_svcs_version", True),
    ("Cloud Pak for Data - Platform", "cp4d-platform", "ibm-zen", "ibm_zen_version", True),
    ("Cloud Pak for Data - Platform", "cp4d-platform", "ibm-cp-datacore", "cp4d_platform_version", True),
    ("Cloud Pak for Data - Platform", "cp4d-platform", "ibm-swhub-control-center", "swhub_version", True),
    ("Cloud Pak for Data - Platform", "cp4d-platform", "ibm-licensing", "ibm_licensing_version", True),
    ("Cloud Pak for Data - Platform", "cp4d-platform", "ibm-ccs", "ccs_build", True),
    ("Cloud Pak for Data - Platform", "cp4d-platform", "ibm-cloud-native-postgresql", "postgress_version", True),
    ("Cloud Pak for Data - Platform", "cp4d-platform", "ibm-pg-operator", "pg_operator_version", True),
