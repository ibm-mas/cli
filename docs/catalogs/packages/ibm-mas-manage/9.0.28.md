...
IBM Maximo Manage v9.0.28
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Synchronise BDI and Manage major/minor versions. (#3781)
- fix the molecule failure for 9.0.x (#3808)
- final image update for july release (#3846)
