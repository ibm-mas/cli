...
- MASISMIG-66414 - DT445779 - Installing Manage 8.7.x fails with BuildDataInterpreters (BDI) CRD schema validation (#2637)
- Updated the build number for civil (#2702)
- Updated the latest manageadmin image (#2704)
- Updated the latest image of civil from 8.5.24 to 8.5.25 (#2718)
