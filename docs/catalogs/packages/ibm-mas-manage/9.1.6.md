...
IBM Maximo Manage v9.1.6
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- MASCORE-7514 - SPS migration for 9.1.x Operator (#2898)
- Updated the addonverdepen and supported-images files (#2907)
- Fix filebeat flags (#2927)
- Reverted the build for aip (#2936)
- updated operand version for healtheext-ws ,acc to 2.1.23 (#2940)
- Updated the major version of ansible-operator from 8.1.1 to 9.1.2 (#2946)
- updated operand image MAXMOA-13588 (#2956)
- Reverted the serviceprovider version in addonverdependency.yaml file (#2957)
- reverting back managemonitoringopenshift to 5.0.17 from 5.0.18 (#2959)
- updated new manage image which has ubi-wlp-manage 4.0.21 fix. (#2962)
- updated operand image version to fix the SR issue (#2963)
- adding final image for Nov release 9.1.6 (#2969)
- reverted ansible operator version from 9.1.2 to 9.0.6 (#2974)
