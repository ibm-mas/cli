...
class TestCollectAirgapResources:
    ...
    def test_collect_airgap_resources_collects_mirror_resources(self):
        ...
        assert os.path.exists(os.path.join(self.testDir, "resources", "_cluster", "imagecontentsourcepolicy.md"))
    ...
    def test_collect_airgap_resources_collects_machineconfig(self):
        ...
        assert result is True
        assert os.path.exists(os.path.join(self.testDir, "resources", "_cluster", "machineconfig.md"))
