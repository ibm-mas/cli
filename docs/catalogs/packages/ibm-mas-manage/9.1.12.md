...
IBM Maximo Manage v9.1.12
================================================================================

Release Notes
--------------------------------------------------------------------------------
- Update ansible operator version from 9.1.4 to 9.1.11 along with script fixes(9.1.x) (#3287)
- Reverted back the manage-server-bundle-dockerfile.j2 to fix the build config issue. (#3291)
- updated ansible operator to 9.1.15 for interim release (#3367)
- Updated the healthext and imagestitching verison in operator.yaml for March Interim (#3374)
- added slackproxy with ansible operator 9.1.15
- address kubernetes no_proxy issue MASISMIG-73418
