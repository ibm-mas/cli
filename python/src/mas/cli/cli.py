    ...
    def __init__(self) -> None:
        ...
        self.compatibilityMatrix: Dict[str, Dict[str, List[str]]] = {
            ...
            "9.2.x": {
                ...
                "visualinspection": ["9.2.x", "9.2.x-feature", "9.1.x", "9.1.x-dev"],
                "iot": ["9.2.x", "9.2.x-feature", "9.1.x", "9.1.x-dev"],
                "monitor": ["9.2.x", "9.2.x-feature", "9.1.x", "9.1.x-dev"],
                "predict": ["9.2.x", "9.2.x-feature", "9.1.x", "9.1.x-dev"],
                "facilities": ["9.2.x", "9.2.x-feature", "9.1.x", "9.1.x-dev"],
            },
            "9.2.x-feature": {
            ...
            "9.1.x-dev": {
                "facilities": ["9.1.x-dev"],
                "assist": ["9.1.x-dev", "9.0.x"],
                "iot": ["9.1.x-dev", "9.0.x"],
                "manage": ["9.1.x-dev", "9.1.x-feature", "9.0.x"],
                "monitor": ["9.1.x-dev", "9.0.x"],
                "optimizer": ["9.1.x-dev", "9.1.x-feature", "9.0.x"],
