...
IBM Maximo Application Suite v9.0.28
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Update mobileapi version for graphite update (#5201)
- Fix molecule driver compatibility with molecule 25.x (#5234)
- Update mobileapi version for graphite update (#5237)
- Update supported image digests for versions 9.0.x (#5221)
- Update mobileapi version for graphite update (#5247)
- update admindashboard to 11.12.133 (#5251)
