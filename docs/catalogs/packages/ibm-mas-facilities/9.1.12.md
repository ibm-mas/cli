...
IBM Maximo Real Estate and Facilities v9.1.12
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- oidc will use internal svc endpoints (#522)
- Added metadata labels to fix kyerno policy exception (#533)
- Added missing labels in spec for kyverno policies - 9.1 (#536)
- Added topologySpreadConstraints for platform pods - 9.1 (#542)
- Promoting platform build 403891 to maint91x (#543)
- promoting platform build 9100002 to maint91x (#548)
