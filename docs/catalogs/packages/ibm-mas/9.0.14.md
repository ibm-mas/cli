...
IBM Maximo Application Suite v9.0.14
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Fix for Labels & update of Graphite to v2.13.617 (#4011)
- Make email optional when creating and updating a user (90x) (#4054)
- updated mobileapi version (#4070)
- Add new environment variable LOG_LEVEL 90x (#4021)
- Fix to include templates folder into /opt/ibm/sendmailapi folder - 9.0.x (#4092)
- upgrade coreidplogin to latest (#4087)
- Include users without email in sendmail_bulk payload (90x) (#4100)
- update coreapi image, for changes for PackageManifest for 9.0 version (#4095)
- Use latest sendmailapi build to allow toAdress to be null (90x) (#4126)
