...
IBM Maximo Application Suite v9.0.19
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- mobileapi update to update navigator and it's graphite version to v2.13.647 (#4467)
- mobileapi update to update navigator and it's graphite version to v2.13.652 (#4507)
- Update ansible-operator (#4490)
- update mas util to 7.27.2: 90x (#4537)
- downgrade wlp - 90x (#4544)
- Fixing mobile dedicated login page - 90 (#4548)
- Add smtp ouath2 for outgoing emails 9.0.x [MASCORE-10041] (#4575)
