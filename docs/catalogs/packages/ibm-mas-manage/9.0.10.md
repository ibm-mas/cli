...
IBM Maximo Manage v9.0.10
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- MASISMIG-61379 - Update buildtag pattern into CRD (#2189)
- MASISMIG-56168 - Correcting Jinja templating issue to align with change in 8.7.x. (#1876)
- update maxloader ref to current (90x) (#2195)
- Add addon placeholders for 9.0.10 release (#2203)
- Update BDI application image to latest version (#2183)
- Correction to the schema of ManageWorkspace CRD: 90x (#2201)
- Updated the version of monitoring openshift from 4.1.10 to 4.… (#2215)
- manually updated manageadmin image 9.0.84 (#2220)
- add final image update for 9.0.10 release (#2223)
