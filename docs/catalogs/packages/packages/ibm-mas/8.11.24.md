...
IBM Maximo Application Suite v8.11.24
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Remove hardcoded creds in Molecule (#3725)
- Fix for Labels & update of Graphite to v2.12.438 for MAS811 Navigator-App (#3905)
- Fix for Labels & update of Graphite to v2.12.440 for MAS811 Navigator-App (#3947)
- Fix for Labels & update of Graphite to v2.12.442 for MAS811 Navigator-App (#3968)
- After the password change flow of the login page, redirect to the /authorize URL, to make sure the user will end up in the desired logged page instead of MAS homepage (811x) (#3990)
- Add 811x prev release into rollback supported images list (811x) (#3982)
- update kubectl 4.0.16: 811 (#3999)
