...
| :--------------------------------------- | :--------------------------------------- | :------------------------------------------------------------------------------- |
| rbac.authorization.k8s.io                | clusterroles                             | create, delete                                                                   |
| rbac.authorization.k8s.io                | clusterrolebindings                      | create, delete                                                                   |
...
| oidc.security.ibm.com                    | clients/finalizers                       | patch, update                                                                    |
...
| networking.k8s.io                        | ingresses                                | delete, get, list, watch                                                         |
| batch                                    | jobs                                     | create, delete, get, list, patch, update, watch                                  |
| rbac.authorization.k8s.io                | roles                                    | create, delete                                                                   |
| rbac.authorization.k8s.io                | rolebindings                             | create, delete                                                                   |
...
| postgresql.k8s.enterprisedb.io           | clusters                                 | get, list, watch                                                                 |
| secrets-store.csi.x-k8s.io               | secretproviderclasses                    | get, list, watch                                                                 |
