IBM Maximo Operator Catalog v9 (260625)
===============================================================================
...
* A known issue exists in the June 26, 2026 release affecting IBM Maximo Visual Inspection. Customers with MVI installed and using custom cluster issuer should avoid upgrading to the June release. Installation of MVI 9.2.x should be deferred until the July 2026 patch.
...
|--------------------------|-------------------|---------------|---------------------------------------------------------------------------------------|
| ibm-aiservice            | 9.1.x             | 9.2.x-feature | [9.2.0-pre.stable-21747](packages/ibm-aiservice/9.2.0-pre.stable-21747.md)            |
|                          |                   | 9.1.x         | [9.1.15](packages/ibm-aiservice/9.1.15.md)                                            |
| ibm-aiservice-tenant     | 9.2.x-feature     | 9.2.x-feature | [9.2.0-pre.stable-21714](packages/ibm-aiservice-tenant/9.2.0-pre.stable-21714.md)     |
| ibm-mas                  | 9.1.x             | 9.2.x-feature | [9.2.0-pre.stable-21734](packages/ibm-mas/9.2.0-pre.stable-21734.md)                  |
|                          |                   | 9.1.x         | [9.1.18](packages/ibm-mas/9.1.18.md)                                                  |
|                          |                   | 9.0.x         | [9.0.26](packages/ibm-mas/9.0.26.md)                                                  |
...
| ibm-mas-arcgis           | 9.1.x             | 9.1.x         | [9.1.9](packages/ibm-mas-arcgis/9.1.9.md)                                             |
|                          |                   | 9.0.x         | [9.0.10](packages/ibm-mas-arcgis/9.0.10.md)                                           |
| ibm-mas-assist           | 9.1.x             | 9.1.x         | [9.1.11](packages/ibm-mas-assist/9.1.11.md)                                           |
|                          |                   | 9.0.x         | [9.0.17](packages/ibm-mas-assist/9.0.17.md)                                           |
|                          |                   | 8.8.x         | [8.8.7](packages/ibm-mas-assist/8.8.7.md)                                             |
|                          |                   | 8.7.x         | [8.7.8](packages/ibm-mas-assist/8.7.8.md)                                             |
| ibm-mas-facilities       | 9.1.x             | 9.2.x-feature | [9.2.0-pre.stable-16853](packages/ibm-mas-facilities/9.2.0-pre.stable-16853.md)       |
|                          |                   | 9.1.x         | [9.1.11](packages/ibm-mas-facilities/9.1.11.md)                                       |
| ibm-mas-hputilities      | 8.6.x             | 8.6.x         | [8.6.7](packages/ibm-mas-hputilities/8.6.7.md)                                        |
| ibm-mas-iot              | 9.1.x             | 9.2.x-feature | [9.2.0-pre.stable-21024](packages/ibm-mas-iot/9.2.0-pre.stable-21024.md)              |
|                          |                   | 9.1.x         | [9.1.11](packages/ibm-mas-iot/9.1.11.md)                                              |
|                          |                   | 9.0.x         | [9.0.20](packages/ibm-mas-iot/9.0.20.md)                                              |
|                          |                   | 8.8.x         | [8.8.30](packages/ibm-mas-iot/8.8.30.md)                                              |
|                          |                   | 8.7.x         | [8.7.33](packages/ibm-mas-iot/8.7.33.md)                                              |
| ibm-mas-manage           | 9.1.x             | 9.2.x-feature | [9.2.0-pre.stable-21956](packages/ibm-mas-manage/9.2.0-pre.stable-21956.md)           |
|                          |                   | 9.1.x         | [9.1.18](packages/ibm-mas-manage/9.1.18.md)                                           |
|                          |                   | 9.0.x         | [9.0.26](packages/ibm-mas-manage/9.0.26.md)                                           |
|                          |                   | 8.7.x         | [8.7.32](packages/ibm-mas-manage/8.7.32.md)                                           |
|                          |                   | 8.6.x         | [8.6.38](packages/ibm-mas-manage/8.6.38.md)                                           |
| ibm-mas-monitor          | 9.1.x             | 9.2.x-feature | [9.2.0-pre.stable-21784](packages/ibm-mas-monitor/9.2.0-pre.stable-21784.md)          |
|                          |                   | 9.1.x         | [9.1.11](packages/ibm-mas-monitor/9.1.11.md)                                          |
|                          |                   | 9.0.x         | [9.0.20](packages/ibm-mas-monitor/9.0.20.md)                                          |
|                          |                   | 8.11.x        | [8.11.28](packages/ibm-mas-monitor/8.11.28.md)                                        |
|                          |                   | 8.10.x        | [8.10.30](packages/ibm-mas-monitor/8.10.30.md)                                        |
| ibm-mas-optimizer        | 9.1.x             | 9.2.x-feature | [9.2.0-pre.stable-21493](packages/ibm-mas-optimizer/9.2.0-pre.stable-21493.md)        |
|                          |                   | 9.1.x         | [9.1.12](packages/ibm-mas-optimizer/9.1.12.md)                                        |
|                          |                   | 9.0.x         | [9.0.23](packages/ibm-mas-optimizer/9.0.23.md)                                        |
|                          |                   | 8.5.x         | [8.5.28](packages/ibm-mas-optimizer/8.5.28.md)                                        |
|                          |                   | 8.4.x         | [8.4.28](packages/ibm-mas-optimizer/8.4.28.md)                                        |
| ibm-mas-predict          | 9.1.x             | 9.2.x-feature | [9.2.0-pre.stable-22454](packages/ibm-mas-predict/9.2.0-pre.stable-22454.md)          |
|                          |                   | 9.1.x         | [9.1.8](packages/ibm-mas-predict/9.1.8.md)                                            |
|                          |                   | 9.0.x         | [9.0.15](packages/ibm-mas-predict/9.0.15.md)                                          |
|                          |                   | 8.9.x         | [8.9.17](packages/ibm-mas-predict/8.9.17.md)                                          |
|                          |                   | 8.8.x         | [8.8.15](packages/ibm-mas-predict/8.8.15.md)                                          |
| ibm-mas-visualinspection | 9.1.x             | 9.2.x-feature | [9.2.0-pre.stable-12598](packages/ibm-mas-visualinspection/9.2.0-pre.stable-12598.md) |
|                          |                   | 9.1.x         | [9.1.17](packages/ibm-mas-visualinspection/9.1.17.md)                                 |
|                          |                   | 9.0.x         | [9.0.20](packages/ibm-mas-visualinspection/9.0.20.md)                                 |
...
| ibm-sls             | 3.x               | 3.x       | [3.12.8](packages/ibm-sls/3.12.8.md)             |
| ibm-truststore-mgr  | 1.x               | 1.x       | [1.7.6](packages/ibm-truststore-mgr/1.7.6.md)    |
...
| ibm-cert-manager-operator           | v3.23             | v4.2         | [4.2.21](packages/ibm-cert-manager-operator/4.2.21.md)             |
...
| ibm-events-operator                 | v6.1              | v6.1         | [6.1.0](packages/ibm-events-operator/6.1.0.md)                     |
...
| isf-operator                        | v2.0              | v2.0         | [2.12.2](packages/isf-operator/2.12.2.md)                          |
...
|                               |                   | v4.17     | [4.17.0](packages/ibm-iam-operator/4.17.0.md)               |
...
| ibm-watson-discovery-operator | v11.2             | v9.2      | [9.2.0](packages/ibm-watson-discovery-operator/9.2.0.md)    |
...
| ibm-watson-gateway-operator   | v1.0              | v1.0      | [2.2.2](packages/ibm-watson-gateway-operator/2.2.2.md)      |

### IBM Db2 Universal Operator
| Package       | Default Channel   | Channel   | Latest Version                                     |
|---------------|-------------------|-----------|----------------------------------------------------|
| db2u-operator | v110509.0         | v7.8      | [7.8.0](packages/db2u-operator/7.8.0.md)           |
...
| ibm-appconnect   | v13.1             | v9.2      | 9.2.1                                         |
|                  |                   | v9.1      | 9.1.0                                         |
|                  |                   | v9.0      | 9.0.0                                         |
|                  |                   | v8.2      | 8.2.1                                         |
|                  |                   | v8.1      | 8.1.0                                         |
...
| Package                | Default Channel   | Channel   | Latest Version                                    |
|------------------------|-------------------|-----------|---------------------------------------------------|
| eclipse-amlen-operator | 1.x               | 1.x       | [1.1.4](packages/eclipse-amlen-operator/1.1.4.md) |
