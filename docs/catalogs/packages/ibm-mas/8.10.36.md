...
IBM Maximo Application Suite v8.10.36
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- security fix for axios, lodash, lodash-es and qs- 810 (#4735)
- emergency downgrade of kubernetes python MASISMIG-73418 fix dependencies 810x (#4784)
