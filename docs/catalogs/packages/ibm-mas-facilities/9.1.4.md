...
IBM Maximo Real Estate and Facilities v9.1.4
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Promote platform 402303 to maint91xdev (#285)
- add validation for deleted queries on CBA runNamedQuery and runNamedQueryMultiBO operations (#288)
- Promote release candidate 9.1.4_402313 to 9.1.4 for GA (#292)
