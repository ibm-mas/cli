...
IBM Maximo Manage v8.6.32
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- MASCORE-7514 - SPS migration for 8.6.x Operator (#2901)
- Fix filebeat flags (#2930)
- Updated the ansible-operator from 7.13.3 to 9.1.2 (#2947)
- Updated the latest image for manageadmin (#2951)
- Reverted ansible-operator version from 9.1.2 to 9.0.6 (#2973)
