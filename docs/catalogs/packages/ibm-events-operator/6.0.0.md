...
| ibmevents.ibm.com                        | kafkas/finalizers                        | update                                                                           |
| ibmevents.ibm.com                        | kafkanodepools/finalizers                | update                                                                           |
| ibmevents.ibm.com                        | kafkaconnects/finalizers                 | update                                                                           |
| ibmevents.ibm.com                        | kafkaconnectors/finalizers               | update                                                                           |
| ibmevents.ibm.com                        | kafkabridges/finalizers                  | update                                                                           |
| ibmevents.ibm.com                        | kafkamirrormaker2s/finalizers            | update                                                                           |
| ibmevents.ibm.com                        | kafkarebalances/finalizers               | update                                                                           |
...
| ibmevents.ibm.com                        | kafkatopics/finalizers                   | update                                                                           |
| ibmevents.ibm.com                        | kafkausers/finalizers                    | update                                                                           |
...
| core.ibmevents.ibm.com                   | strimzipodsets/finalizers                | update                                                                           |
