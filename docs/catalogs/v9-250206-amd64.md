...
<table>
  ...
  <tr><td>Tag</td><td>v9-250109-amd64</tr></tr>
  <tr><td>Digest</td><td>sha256:028f32213d3f14405eda7e78aaec28411688272f3358c5a34f6ebed6cf46c4c3</tr></tr>
</table>
...
Manual Installation
-------------------------------------------------------------------------------
`oc apply -f https://raw.githubusercontent.com/ibm-mas/cli/master/catalogs/v9-250109-amd64.yaml`
...
spec:
  displayName: IBM Maximo Operators (v9-250109-amd64)
  publisher: IBM
  description: Static Catalog Source for IBM Maximo Application Suite
  sourceType: grpc
  image: icr.io/cpopen/ibm-maximo-operator-catalog@sha256:028f32213d3f14405eda7e78aaec28411688272f3358c5a34f6ebed6cf46c4c3
  priority: 90
```
...
|                          |                   | 8.11.x        | [8.11.18](packages/ibm-mas/8.11.18.md)                                              |
|                          |                   | 8.10.x        | [8.10.21](packages/ibm-mas/8.10.21.md)                                              |
| ibm-mas-aibroker         | 9.0.x             | 9.0.x         | [9.0.5](packages/ibm-mas-aibroker/9.0.5.md)                                         |
...
|                          |                   | 8.7.x         | [8.7.15](packages/ibm-mas-manage/8.7.15.md)                                         |
|                          |                   | 8.6.x         | [8.6.21](packages/ibm-mas-manage/8.6.21.md)                                         |
| ibm-mas-monitor          | 9.0.x             | 9.0.x         | [9.0.5](packages/ibm-mas-monitor/9.0.5.md)                                          |
|                          |                   | 8.11.x        | [8.11.13](packages/ibm-mas-monitor/8.11.13.md)                                      |
|                          |                   | 8.10.x        | [8.10.15](packages/ibm-mas-monitor/8.10.15.md)                                      |
| ibm-mas-optimizer        | 9.0.x             | 9.1.x-feature | [9.1.0-pre.stable-1628](packages/ibm-mas-optimizer/9.1.0-pre.stable-1628.md)        |
|                          |                   | 9.0.x         | [9.0.6](packages/ibm-mas-optimizer/9.0.6.md)                                        |
|                          |                   | 8.5.x         | [8.5.12](packages/ibm-mas-optimizer/8.5.12.md)                                      |
|                          |                   | 8.4.x         | [8.4.13](packages/ibm-mas-optimizer/8.4.13.md)                                      |
| ibm-mas-predict          | 9.0.x             | 9.0.x         | [9.0.4](packages/ibm-mas-predict/9.0.4.md)                                          |
|                          |                   | 8.9.x         | [8.9.7](packages/ibm-mas-predict/8.9.7.md)                                          |
|                          |                   | 8.8.x         | [8.8.5](packages/ibm-mas-predict/8.8.5.md)                                          |
...
| Package             | Default Channel   | Channel   | Latest Version                                   |
|---------------------|-------------------|-----------|--------------------------------------------------|
| ibm-data-dictionary | 1.1.x             | 1.1.x     | [1.1.14](packages/ibm-data-dictionary/1.1.14.md) |
