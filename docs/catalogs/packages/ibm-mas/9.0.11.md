...
IBM Maximo Application Suite v9.0.11
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- [MASCORE-6141] readd python wheels to help speed up builds 90x (#3648)
- retry to look up internalapi url from Suite CR status : 90x (#3635)
- Add Power (ppc64le) support (#3649)
- Fix for Labels pertaining to MAS90 Navigator-App and includes v2.13.580 Graphite (#3661)
- Added new value metric for manage 9.0 (#3667)
- rename adoptionusage-metering python filename as it was changed (#3681)
- Fix the issue where updating users in LDAP caused their entitlement and permissions data to be overwritten in MAS (90x) (#3680)
- Add 90x prev release into rollback supported images list (90x) (#3672)
- remove erroneous validation of SCIM list attributes which don't have 'primary' field (#3679)
- Fix for Labels pertaining to MAS90 Navigator-App (#3701)
- Add Support for GenericAddon CRD and Deprecate ReplicaDB CRD (#3711)
- Fix for Labels & update of Graphite to v2.13.585 for MAS90 Navigator-App (#3734)
- correct image tags for coreapi and internalapi (#3744)
