...
| config.openshift.io                      | clusterversions/status                   | get, list, patch, update, watch                                                  |
...
| config.openshift.io                      | imagedigestmirrorsets                    | get, list, watch                                                                 |
| config.openshift.io                      | images                                   | get, list, watch                                                                 |
...
| data-protection.isf.ibm.com              | syncpolicies/status                      | get, patch, update                                                               |
...
| data-protection.isf.ibm.com              | syncpolicies                             | create, delete, get, list, patch, update, watch                                  |
...
| data-protection.isf.ibm.com              | syncpolicies/finalizers                  | update                                                                           |
...
| mgmtsft.isf.ibm.com                      | isfgraphqldeps                           | create, delete, get, list, patch, update, watch                                  |
| mgmtsft.isf.ibm.com                      | isfgraphqldeps/finalizers                | update                                                                           |
| mgmtsft.isf.ibm.com                      | isfgraphqldeps/status                    | get, patch, update                                                               |
...
| operator.openshift.io                    | imagecontentsourcepolicies               | get, list, watch                                                                 |
