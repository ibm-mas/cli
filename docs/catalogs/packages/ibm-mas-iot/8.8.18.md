...
IBM Maximo IoT v8.8.18
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- update monagentiot version 88x (#617)
- update ansible-operator-iot (#624)
- IBMIOT-806 Update Services and Requirements (#632)
- Update state to address security fix (#636)
