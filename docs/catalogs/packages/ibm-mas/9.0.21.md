...
IBM Maximo Application Suite v9.0.21
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- mobileapi update to update navigator and it's graphite version to v2.13.654 (#4599)
- mobileapi update to update navigator and it's graphite version to v2.13.656 (#4623)
- mobileapi update to update navigator and it's graphite version to v2.13.657 (#4625)
- update ansible and internal packages (#4669)
