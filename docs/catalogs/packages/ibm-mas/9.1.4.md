...
IBM Maximo Application Suite v9.1.4
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- internalapi image updated, for updating the swagger validation for UserPayload owner values for 9.1 (#4139)
- Remove secrets data from logs - 91x (#4142)
- Enabling ACM, ICD and strategize for PowerPC and s390x: 9.1 (#4137)
- Fix for Labels & update of Graphite to v3.1.590 (#4159)
- Configure TLS for monagent-mas and workspace-coordinator probes in 9.1.x (#4150)
- Use latest coreapi build to fix a bug which made forgotpassword function to fail (91x) (#4153)
- Updated ansible-operator, coreapi and admindashboard versions to fix power filebeat issue (#4171)
- Fix a runtime error in the UI when a certain combination of versions in supportedVersions array in the GET /about API response is returned (91x) (#4177)
- Fix users synced in MAS without any emails should not get excluded (91x) (#4174)
- Fix the issue where the added.timestamp value was being updated for existing users in bulk users upsert API (91x) (#4185)
- update non ibm license and notice (91x) (#4194)
