...
IBM Maximo Application Suite v9.0.15
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Fix for Labels & update of Graphite to v2.13.624 (#4124)
- Remove secrets data from logs - 90x (#4141)
- Fix for Labels & update of Graphite to v2.13.631 (#4160)
- Configure TLS for monagent-mas and workspace-coordinator probes in 9.0.x (#4131)
- Fix users synced in MAS without any emails should not get excluded (90x) (#4173)
- Fix a runtime error in the UI when a certain combination of versions in supportedVersions array in the GET /about API response is returned (90x) (#4178)
- Fix the issue where the added.timestamp value was being updated for existing users in bulk users upsert API (90x) (#4186)
