...
IBM Maximo Real Estate and Facilities v9.1.10
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Added scanSettings to whitesource (#418)
- Remove unused packages 91x (#425)
- Change the metadata label to exclude the image from Kyverno’s digest validation - 91x (#446)
- Promoting build 403466 for maint91x (#451)
- MASREF-1920: changes for usersync agent (#466)
- Promote release candidate 9.1.10_403466 to 9.1.10 for GA (#468)
