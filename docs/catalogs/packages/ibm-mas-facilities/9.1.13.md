...
IBM Maximo Real Estate and Facilities v9.1.13
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- removed redundant cert config for db2 (#553)
- Fixed the Finalizer and OIDC unregister call - 91x (#562)
- multiple backport fixed for Platform with build 9100007 (#573)
- Added topologySpreadConstraints in usersyncagent (#588)
- MASREF-5929:One moment please loading wheel is flashing (#589)
- Promote release candidate 9.1.13_9100008 to 9.1.13 for GA (#593)
