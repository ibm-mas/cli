...
IBM Maximo Manage v9.0.24
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Updated the ansible-operator version to 9.1.11 and scripts to support latest K8s.client ansible collection (#3324)
- Added a fix for the app-manage-cfg failing MASCORE-12631 (#3350)
- DT462849 - BDI pod logs contain verbose garbage collection output (9.0.x) (#3347)
- Updated the ansible-operator version from 9.1.11 to 9.1.15 (#3368)
- updated the manageadmin for march release (#3382)
