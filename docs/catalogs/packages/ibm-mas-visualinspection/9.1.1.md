...
Maximo Visual Inspection v9.1.1
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Update PIDs in copyright.yml (#743)
- Update Grafanadashboard to include PVC usage (#745)
- MVI needs connect-src CSP updated to support Qualtrics MASMVI-2393 (#746)
- Add code owners and PR template (#759)
- bump DLE (#760)
- Add UI for RBAC migration operations (#761)
- bump dle to get ocr fix MASMVI-2543 (#763)
