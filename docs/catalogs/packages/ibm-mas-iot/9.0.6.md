...
IBM Maximo IoT v9.0.6
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Fix the ContainerLivenessOverLongInitialDelaySecond (#573)
- IBMIOT-757 Update ltpakey to latest version (#581)
- IBMIOT-757 Update Baseimag Requirements and Operators (#585)
- IBMIOT-757 Fix for the Jdbc auth-store Hibernate Rebuild Issue (#589)
- updates to fully unwind bad Hibernate upgrade IBMIOT-757 90x (#593)
