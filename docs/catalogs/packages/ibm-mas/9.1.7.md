...
IBM Maximo Application Suite v9.1.7
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- mobileapi update to update navigator and it's graphite version to v3.1.624 (#4383)
- Add imgSrc CSP override to allow data url to be used when overriding the login page background image (91x) (#4385)
- Remove Assist's Watson Discovery dependency (#4119)
- Backport read-only root filesystem support (disabled by default) (#4392)
- internalapi 10.3.0 - Add internal versions of put/delete message APIs and update dependencies (#4421)
- Update catalogapi image to support read-only enabled/disabled (#4425)
- mobileapi update to update navigator and it's graphite version to v3.1.627 (#4423)
- Updated mobileapi to avoid permission errors with new read-only flag - 9.1.x (#4436)
- Updated internalapi to avoid permission errors with new read-only flag - 9.1.x (#4438)
- Increase destroy timeout and improved molecule tests (#4449)
- mobileapi update to update navigator and it's graphite version to v3.1.630 (#4455)
- removed sensitive logs - 91x (#4429)
- Add defaultSenderEmail to the /systeminfo internal API response (91x) (#4448)
