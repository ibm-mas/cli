...
| redis.ibm.com                            | rediscps                                 | create, delete, get, list, patch, update, watch                                  |
| redis.ibm.com                            | rediscps/finalizers                      | create, delete, get, list, patch, update, watch                                  |
| redis.ibm.com                            | rediscps/spec                            | create, delete, get, list, patch, update, watch                                  |
| redis.ibm.com                            | rediscps/status                          | create, delete, get, list, patch, update, watch                                  |
