IBM Maximo Operator Catalog v8 (230328)
===============================================================================
...
<table>
  ...
  <tr><td>Tag</td><td>v8-230328-amd64</tr></tr>
...
Manual Installation
-------------------------------------------------------------------------------
`oc apply -f https://raw.githubusercontent.com/ibm-mas/cli/master/catalogs/v8-230328-amd64.yaml`
...
spec:
  displayName: IBM Maximo Operators (v8-230328-amd64)
  publisher: IBM
