...
IBM Maximo Real Estate and Facilities v9.1.9
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- updated ansible operator to 8.1.13 (#380)
- changes to promote build 403338 on maint91x channel (#404)
- upgraded ansible-operator base image to 9.1.12 (#408)
- changes for triDrawingManager issue (#414)
- promoting platform build 403375 for maint91x (#417)
