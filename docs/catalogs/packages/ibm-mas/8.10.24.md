...
IBM Maximo Application Suite v8.10.24
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- update mobileapi version : MAS-810 (#3541)
- Fix phone number size limitation 8.10.x (#3564)
- Fix string type for ssoCookieName - 810 (#3451)
- update mobileapi version : MAS-810 (#3590)
- fix log for molecule test resources (#3584)
- resloving detect-secret findigs (#3601)
- Fix bulk sendmail endpoint to also check for disabled email templates (8.10.x) (#3618)
