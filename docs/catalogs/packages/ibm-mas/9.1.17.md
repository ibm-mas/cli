...
IBM Maximo Application Suite v9.1.17
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Remove adoption usage hourly CronJob for 91 (#4914)
- mobileapi update to update navigator and it's graphite version (#4969)
- support digets for imageTags and increased auth timeout in internalapi (#4976)
- Fix for digest handling in settings.imageTags (#4989)
