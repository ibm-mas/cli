...
class ManageSettingsMixin():
    ...
    def aiBrokerSettings(self) -> None:
            self.setParam("mas_aibroker_channel", self.getParam("mas_app_channel_manage"))
            ...
            if self.yesOrNo("Include IBM Maximo AI Broker"):
                ...
                self.promptForString("storage_provider", mas_aibroker_storage_provider")
                self.promptForSecret("storage_accesskey", mas_aibroker_storage_accesskey")
                self.promptForSecret("storage_secretkey", mas_aibroker_storage_secretkey")
                self.promptForString("storage_host", mas_aibroker_storage_host")
                self.promptForString("storage_port", mas_aibroker_storage_port")
                self.promptForString("storage_ssl", mas_aibroker_storage_ssl")
                self.promptForString("storage_region", mas_aibroker_storage_region")
                self.promptForString("storage_pipelines_bucket", mas_aibroker_storage_pipelines_bucket")
                self.promptForString("storage_tenants_bucket", mas_aibroker_storage_tenants_bucket")
                self.promptForString("storage_templates_bucket", mas_aibroker_storage_templates_bucket")
                self.promptForSecret("watsonxai_apikey", mas_aibroker_watsonxai_apikey")
                self.promptForString("watsonxai_url", mas_aibroker_watsonxai_url")
                self.promptForString("watsonxai_project_id", mas_aibroker_watsonxai_project_id")
                self.promptForString("db_host", mas_aibroker_db_host")
                self.promptForString("db_por", mas_aibroker_db_port")
                self.promptForString("db_user", mas_aibroker_db_user")
                self.promptForString("db_database", mas_aibroker_db_database")
                self.promptForString("secret_name", mas_aibroker_db_secret_name")
                self.promptForSecret("secret_value", mas_aibroker_db_secret_value")
