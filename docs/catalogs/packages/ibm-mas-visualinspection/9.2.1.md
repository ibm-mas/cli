...
Maximo Visual Inspection v9.2.1
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Disallow role with wildcard (#1317)
- Add singleton label to Valkey workload (#1346)
- Adds support for Custom Issuer (#1337)
- Fix NPE during reconciliation of the default internal issuer (#1370)
