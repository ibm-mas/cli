...
IBM Maximo Application Suite v9.1.16
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Fix Operator Maturity test for MASCORE-12797 (#4896)
- Force the redeploy of scimsync liberty server when LDAP password changes for MASISMIG-73055 issue 91x (#4898)
- April config version with graphite version (#4935)
- security fix for axios - maint91 (#4940)
- update accapppoints: 3.11.66 91x (#4952)
