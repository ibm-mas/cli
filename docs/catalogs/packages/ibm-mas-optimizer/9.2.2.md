...
IBM Maximo Optimizer v9.2.2
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- MSO-2742 (9.2.x) - CVEs fixes - pyasn1-0.6.3-py3-none-any.whl (#501)
- support manualRouteMgmt to disable automatic route creation in 92x (#498)
- MSO-2768 (9.2.x) - cryptography-46.0.7-cp311-abi3-manylinux_2_34_x86_64.whl (#511)
