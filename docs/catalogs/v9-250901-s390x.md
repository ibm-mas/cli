...
<table>
  ...
  <tr><td>Tag</td><td>v9-250901-s390x</tr></tr>
...
Manual Installation
-------------------------------------------------------------------------------
`oc apply -f https://raw.githubusercontent.com/ibm-mas/cli/master/catalogs/v9-250901-s390x.yaml`
...
spec:
  displayName: IBM Maximo Operators (v9-250901-s390x)
  publisher: IBM
