...
IBM Maximo Manage v8.7.26
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- MASCORE-7514 - SPS migration for 8.7.x Operator (#2900)
- Fix filebeat flags (#2929)
- Updated the latest build of manage (#2935)
- Updated the latest build for manageadmin (#2944)
- Updated the ansible-operator from 7.13.3 to 9.1.2 (#2945)
- Updated images for manageadmin and utilities (#2952)
- added new spatial operand image 8.7.22-pre.maint87xdev_1190 (#2960)
- Reverted the ansible-operator version from 9.1.2 to 9.0.6 (#2976)
