IBM Maximo Operator Catalog v9 (250925)
===============================================================================
...
<table>
  ...
  <tr><td>Tag</td><td>v9-250925-amd64</tr></tr>
  <tr><td>Digest</td><td>sha256:db5ac0b24bc6c0cb2af8eebcf529fee8ce944196d49aaf7448a00b6e9ffa8d96</tr></tr>
</table>
...
- New **MAS 9.2 feature channels** for Core, Manage and Optimizer offering early access to some of the new features that will be included in the upcoming 9.2 release next year
...
Manual Installation
-------------------------------------------------------------------------------
`oc apply -f https://raw.githubusercontent.com/ibm-mas/cli/master/catalogs/v9-250925-amd64.yaml`
...
spec:
  displayName: IBM Maximo Operators (v9-250925-amd64)
  publisher: IBM
  description: Static Catalog Source for IBM Maximo Application Suite
  sourceType: grpc
  image: icr.io/cpopen/ibm-maximo-operator-catalog@sha256:db5ac0b24bc6c0cb2af8eebcf529fee8ce944196d49aaf7448a00b6e9ffa8d96
  priority: 90
```
...
|--------------------------|-------------------|---------------|-----------------------------------------------------------------------------|
| ibm-aiservice            | 9.1.x             | 9.1.x         | [9.1.7](packages/ibm-aiservice/9.1.7.md)                                    |
...
|                          |                   | 8.11.x        | [8.11.26](packages/ibm-mas/8.11.26.md)                                      |
|                          |                   | 8.10.x        | [8.10.29](packages/ibm-mas/8.10.29.md)                                      |
...
| ibm-mas-assist           | 9.1.x             | 9.1.x         | [9.1.3](packages/ibm-mas-assist/9.1.3.md)                                   |
|                          |                   | 9.0.x         | [9.0.9](packages/ibm-mas-assist/9.0.9.md)                                   |
|                          |                   | 8.8.x         | [8.8.7](packages/ibm-mas-assist/8.8.7.md)                                   |
|                          |                   | 8.7.x         | [8.7.8](packages/ibm-mas-assist/8.7.8.md)                                   |
| ibm-mas-facilities       | 9.1.x             | 9.1.x         | [9.1.3](packages/ibm-mas-facilities/9.1.3.md)                               |
| ibm-mas-hputilities      | 8.6.x             | 8.6.x         | [8.6.7](packages/ibm-mas-hputilities/8.6.7.md)                              |
| ibm-mas-iot              | 9.1.x             | 9.1.x         | [9.1.3](packages/ibm-mas-iot/9.1.3.md)                                      |
|                          |                   | 9.0.x         | [9.0.12](packages/ibm-mas-iot/9.0.12.md)                                    |
|                          |                   | 8.8.x         | [8.8.22](packages/ibm-mas-iot/8.8.22.md)                                    |
|                          |                   | 8.7.x         | [8.7.26](packages/ibm-mas-iot/8.7.26.md)                                    |
| ibm-mas-manage           | 9.1.x             | 9.2.x-feature | [9.2.0-pre.stable-13752](packages/ibm-mas-manage/9.2.0-pre.stable-13752.md) |
|                          |                   | 9.1.x         | [9.1.3](packages/ibm-mas-manage/9.1.3.md)                                   |
|                          |                   | 9.0.x         | [9.0.17](packages/ibm-mas-manage/9.0.17.md)                                 |
|                          |                   | 8.7.x         | [8.7.24](packages/ibm-mas-manage/8.7.24.md)                                 |
|                          |                   | 8.6.x         | [8.6.30](packages/ibm-mas-manage/8.6.30.md)                                 |
| ibm-mas-monitor          | 9.1.x             | 9.1.x         | [9.1.3](packages/ibm-mas-monitor/9.1.3.md)                                  |
|                          |                   | 9.0.x         | [9.0.13](packages/ibm-mas-monitor/9.0.13.md)                                |
|                          |                   | 8.11.x        | [8.11.21](packages/ibm-mas-monitor/8.11.21.md)                              |
|                          |                   | 8.10.x        | [8.10.23](packages/ibm-mas-monitor/8.10.23.md)                              |
| ibm-mas-optimizer        | 9.1.x             | 9.2.x-feature | [9.2.0-pre.stable-525](packages/ibm-mas-optimizer/9.2.0-pre.stable-525.md)  |
|                          |                   | 9.1.x         | [9.1.4](packages/ibm-mas-optimizer/9.1.4.md)                                |
|                          |                   | 9.0.x         | [9.0.15](packages/ibm-mas-optimizer/9.0.15.md)                              |
|                          |                   | 8.5.x         | [8.5.21](packages/ibm-mas-optimizer/8.5.21.md)                              |
|                          |                   | 8.4.x         | [8.4.22](packages/ibm-mas-optimizer/8.4.22.md)                              |
| ibm-mas-predict          | 9.1.x             | 9.1.x         | [9.1.2](packages/ibm-mas-predict/9.1.2.md)                                  |
|                          |                   | 9.0.x         | [9.0.9](packages/ibm-mas-predict/9.0.9.md)                                  |
|                          |                   | 8.9.x         | [8.9.12](packages/ibm-mas-predict/8.9.12.md)                                |
|                          |                   | 8.8.x         | [8.8.10](packages/ibm-mas-predict/8.8.10.md)                                |
| ibm-mas-visualinspection | 9.1.x             | 9.1.x         | [9.1.2](packages/ibm-mas-visualinspection/9.1.2.md)                         |
|                          |                   | 9.0.x         | [9.0.12](packages/ibm-mas-visualinspection/9.0.12.md)                       |
|                          |                   | 8.9.x         | [8.9.15](packages/ibm-mas-visualinspection/8.9.15.md)                       |
