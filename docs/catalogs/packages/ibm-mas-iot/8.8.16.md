...
IBM Maximo IoT v8.8.16
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- IBMIOT-757 Update the baseimage, operators and services (#586)
- IBMIOT-757 Fix for the Jdbc auth-store Hibernate Rebuild Issue (#590)
- updates to fully unwind bad Hibernate upgrade IBMIOT-757 88x (#592)
