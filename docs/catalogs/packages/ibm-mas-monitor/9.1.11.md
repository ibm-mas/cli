...
IBM Maximo Monitor v9.1.11
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Fix Kyverno Policy Failures for Monitor Operator to comply with MAS 9.1 (#1863)
- Generate CRD schemas configmap (91) (#1892)
- updated mas-util version to 7.33.8 (maint91xdev) (#1878)
- update coreapi image to 9.1.424 (#1925)
- fix pre-commit build issue for 91x (#1934)
