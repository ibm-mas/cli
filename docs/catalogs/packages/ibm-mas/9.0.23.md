...
IBM Maximo Application Suite v9.0.23
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Reorder the sequence in which we fetch the wheels (#4443)
- mobileapi update to update navigator and it's graphite version to v2.13.659 (#4689)
- mascore-11749 Add index for applications - 9.0.x (#4595)
- mobileapi update to update navigator and it's graphite version to v2.13.661 (#4721)
- security fix for axios, lodash, lodash-es and qs - 9.0 (#4739)
- Backport only the Suite CRD changes with the new mobile quick setup configuration to 9.0 (#4742)
- Create countrycodes configmap to support PI Compliance 90x (#4700)
- Add 90x prev release into rollback supported images list (90x) (#4445)
- emergency downgrade of kubernetes python MASISMIG-73418 fix dependencies 90x (#4786)
