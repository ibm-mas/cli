...
IBM Maximo Application Suite v9.1.18
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Make entitlement optional in ScimCFG CRD (91x) (#4980)
- Add MAS-Admin-Premium value metric for 91 (#4988)
- Remove AIO parameter from Health cost matrix (#4983)
- Remove enum constraint from GenericAddon addonType for 91 (#5000)
- Update suite image digests for versions 9.0.24, 9.1.15, 9.1.16 (#5044)
- Added new graphite config mount files for read-only system (MAS 9.1) (#5064)
- Some login page error logs are now info logs, since they are not actual errors (91x). (#5077)
- revert scimsync image tag to 3.2.41 (#5116)
