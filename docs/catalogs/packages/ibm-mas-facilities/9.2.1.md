...
IBM Maximo Real Estate and Facilities v9.2.1
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- removed redundant cert config for db2 (#552)
- Fixed the Finalizer and OIDC unregister call (#561)
- delete Brava properties from FACILITIES.properties (#564)
- Refactor the internal certificates (#560)
- added maint92xdev to whitesource scans (#568)
- multiple backport fixed for Platform with build 9200009 (#574)
- Removed the internal certs (#579)
- add subscription role for applying essential role to coreapi and internalapi (#580)
- support manualRouteMgmt to disable automatic route creation (#586)
- multiple backport fixed for Platform with build 9200011 (#587)
- Promote release candidate 9.2.4_9200011 to 9.2.1 for GA (#594)
- Revert- delete Brava properties from FACILITIES.properties (#595)
- multiple backport fixed for Platform with build 9200012 (#599)
- Promote release candidate 9.2.4_9200012 to 9.2.1 for GA (#601)
