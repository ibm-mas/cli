...
IBM Maximo Predict v8.8.9
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- update Settings for correct mime type based on the file extension for MAS8.10 (#1029)
- update predict release versions for MAS 8.10 (#1069)
