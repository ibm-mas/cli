...
IBM Maximo Predict v9.1.9
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- update ansible-operator to 9.3.6 (9.1.x) (#1532)
- updated urllib to 2.7.0, mas-utils to 7.36.2 , requests to 2.34.2 (9.1.x) (#1534)
- update june 91 versions (#1537)
