...
IBM Maximo Manage v9.1.18
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Ephemeral storage code refactor (9.1.x) (#3531)
- add featureuse and deploymentProgression Flags as env vars to foundation and all bundles: 91x (#3551)
- [skip s390x] Operand container image updates (#3603)
- [skip s390x] Operand container image updates (#3605)
- Hardcoded cryptography v46 for UBI8 compatibility and added script to download prebuilt wheels for ibm-mas-manage-webhook image (#3617)
- CRD backport for endpoint configuration support (9.1.x) (#3618)
- Code refactor to reduce Ephemeral Storage consumption and fix some issues (9.1.x) (#3597)
- Remove storageEndpoint validations from ManageWorkspace CRD (9.1.x) (#3634)
- CRD backport for storage endpoint (9.1.x) (#3641)
- Generate CRD schemas configmap (#3649)
- MAXMIS-5849: backport CRD changes to add kafka image processor. (#3646)
- Adding changes for foundation service to support UI pod and DT468223 fixes (9.1.x) (#3669)
- reverted strategize": "9.1.181" this is tested image (#3675)
- updated new manageadmin image which has critical fix MAXMF-5984 (#3685)
- updated final operand for may release and pre-commit-config.yaml (#3693)
- Reverting back foundation service related changes (9.1.x) (#3700)
