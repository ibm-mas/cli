...
Maximo Visual Inspection v8.9.21
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- updates vision-edge-dle in templates/images.yaml to 8.9.21 (#1100)
- Fix pull rate limit against golang - operator build to use icr.io registry (#1107)
