...
IBM Maximo IoT v9.0.23
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Swagger issue fix in webui operator (#1308)
- Update edconfig server for 9.0x (#1327)
- use mfgx with corrected msproxy (#1338)
- Update operators.yaml with new fpl version (#1340)
- use mfgx with updated msproxy (#1344)
- pick up fixes for post-install-verify failures (#1349)
