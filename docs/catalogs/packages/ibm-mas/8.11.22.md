...
IBM Maximo Application Suite v8.11.22
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- retry to look up internalapi url from Suite CR status :811x (#3634)
- Fix for Labels pertaining to MAS811 Navigator-App and includes v2.12.420 Graphite (#3662)
- Adding no_log for verify_jdbc module - 811x (#3656)
- Add 811x prev release into rollback supported images list (811x) (#3673)
- Fix for Labels pertaining to MAS811 Navigator-App (#3699)
