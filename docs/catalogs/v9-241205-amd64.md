...
!!! important
    ...
    **Disconnected environment with Manage Civil, Aviation and ICD**
    Cannot be updated by November, December 2024 & January 2025 patch. These patch does not support new installation of Civil, Aviation and ICD for disconnected environment.
...
| ibm-mas-optimizer        | 9.0.x             | 9.1.x-feature | [9.1.0-pre.stable-1504](packages/ibm-mas-optimizer/9.1.0-pre.stable-1504.md)        |
...
| ibm-mas-visualinspection | 9.0.x             | 9.1.x-feature | [9.1.0-pre.stable-1994](packages/ibm-mas-visualinspection/9.1.0-pre.stable-1994.md) |
