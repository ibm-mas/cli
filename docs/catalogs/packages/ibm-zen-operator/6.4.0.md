...
| cluster.ibm-cpd-mcscheduler.ibm.com      | distributionrule                         | create, delete, get, list, patch, update, watch                                  |
...
| cluster.ibm-cpd-mcscheduler.ibm.com      | physicallocation                         | create, delete, get, list, patch, update, watch                                  |
| cluster.ibm-cpd-mcscheduler.ibm.com      | physicallocations                        | create, delete, get, list, patch, update, watch                                  |
| work.ibm-cpd-mcscheduler.ibm.com         | remotekuberestemplate                    | create, delete, get, list, patch, update, watch                                  |
| work.ibm-cpd-mcscheduler.ibm.com         | remotekuberestemplates                   | create, delete, get, list, patch, update, watch                                  |
