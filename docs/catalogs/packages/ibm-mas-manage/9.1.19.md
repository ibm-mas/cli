...
IBM Maximo Manage v9.1.19
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- update base images and internal python dependencies(9.1.x) (#3625)
- Added the latest manage build include fix for map component and updated supported version matrix and default health for June release (#3761)
