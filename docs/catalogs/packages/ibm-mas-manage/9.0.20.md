...
IBM Maximo Manage v9.0.20
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- update ubi-python to latest(90x) (#3022)
- Backport ManageWorkspace CRD changes from 9.1.x to 9.0.x (9.0.x) (#3046)
- adding final operand for dec release (#3063)
