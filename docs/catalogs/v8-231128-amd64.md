IBM Maximo Operator Catalog v8 (231128)
===============================================================================
...
<table>
  ...
  <tr><td>Tag</td><td>v8-231128-amd64</tr></tr>
  <tr><td>Digest</td><td>sha256:e9f2439166ee18b540b8fc4484e3df5235bfaf7293dadd181b5755c3c79c602a</tr></tr>
</table>


What's New
-------------------------------------------------------------------------------
- **MongoDb v5 (and v6) support**  Running `mas update` will automatically upgrade any existing `MongoDbCommunity` instances from version 4.2 or 4.4 to version 5.0, instances that are still running on version 4.2 will be updated via 4.4 as an intermediate step because direct update to 5. is not supported from 4.2.  This support is available for all supported releases in this catalog
- **Security Updates and Bug Fixes**
    - Maximo Application Suite Core Platform v8.10 and v8.11
    - Maximo IoT v8.7 and v8.8
    - Maximo Manage v8.6 and v8.7
    - Maximo Monitor v8.10 and v8.11


Manual Installation
-------------------------------------------------------------------------------
`oc apply -f https://raw.githubusercontent.com/ibm-mas/cli/master/catalogs/v8-231128-amd64.yaml`
...
spec:
  ...
  sourceType: grpc
  image: icr.io/cpopen/ibm-maximo-operator-catalog@sha256:e9f2439166ee18b540b8fc4484e3df5235bfaf7293dadd181b5755c3c79c602a
  priority: 90
```
...
|                          |                   | 8.5.x     | 8.5.3            |
|                          |                   | 8.6.x     | 8.6.2            |
| ibm-mas-iot              | 8.8.x             | 8.8.x     | 8.8.2            |
|                          |                   | 8.6.x     | 8.6.9            |
|                          |                   | 8.7.x     | 8.7.6            |
| ibm-mas-manage           | 8.7.x             | 8.7.x     | 8.7.2            |
|                          |                   | 8.5.x     | 8.5.9            |
|                          |                   | 8.6.x     | 8.6.7            |
