...
IBM Maximo Application Suite v9.1.22
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Rename MAF catalog entry ID from application-configuration to saas-maf-enablement - 9.1.x (#5397)
- Fix password expiration warning email template variable name in html mode (#5424)
- Cache CoreIDP CRD lookups in authservice user upsert to avoid stressing OpenShift (MASCORE-17106) (#5427)
- Add support for the 'Production Database Access' generic add-on [9.1] (#5210)
