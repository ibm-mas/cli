...
IBM Maximo IoT v8.8.30
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Update operators.yaml to include latest version of edgeconfig (#1137)
- Updating mbgx to 5.0.61 (#1151)
- Update operators.yaml to include latest version of edgeconfig (#1152)
