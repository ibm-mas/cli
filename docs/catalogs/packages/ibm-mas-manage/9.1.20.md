...
IBM Maximo Manage v9.1.20
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Update deploy-components.yml Done the change to handle aip un… (#3774)
- Synchronise BDI and Manage major/minor versions. (#3780)
- fix the molecule failure for 9.1.x (#3807)
- Fix gunicorn folder not creating error in webhook (9.1.x) (#3791)
- final image update for july release (#3845)
