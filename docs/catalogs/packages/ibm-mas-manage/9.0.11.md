...
IBM Maximo Manage v9.0.11
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- addon placeholder for apr release (#2231)
- Update BDI application image to latest version (#2228)
- allow nuclear power with maximo it (#2222)
- removed default value from CRD (#2239)
- Update BDI application image to latest version (#2250)
- manual maximo-IT latest image update (#2261)
- backported attachment provider from 9.1 [MAXMF-555] (#2199)
- add final image update for 9.0.11 release (#2268)
