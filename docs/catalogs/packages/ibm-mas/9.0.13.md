...
IBM Maximo Application Suite v9.0.13
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Remove hardcoded creds in Molecule (#3724)
- CRD Backwards Compatility for settings.qualtrics (#3736)
- Fix to show saas-only configs (add-ons) only in SaaS environments - 9.0.x version (#3901)
- Fix for Labels & update of Graphite to vv2.13.605 for MAS90 Navigator-App (#3906)
- Fix for Labels & update of Graphite to v 2.13.607 for MAS90 Navigator-App (#3948)
- Fix for Labels & update of Graphite to v2.13.612 (#3979)
- After the password change flow of the login page, redirect to the /authorize URL, to make sure the user will end up in the desired logged page instead of MAS homepage (90x) (#3989)
- MASCORE-8239 Fix 9.0.8 entitymgt-suite image digest typo (#3996)
- update kubectl 4.2.26 (#3998)
- Add 90x prev release into rollback supported images list (90x) (#3994)
