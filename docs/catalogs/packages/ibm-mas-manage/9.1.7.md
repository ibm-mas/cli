...
IBM Maximo Manage v9.1.7
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- update ubi-python to latest(91x) (#3021)
- Read-Only Root file system (ibm-require-ro-rootfs) support (9.1.x) (#3026)
- added manage latest image to include inspection regration fix MAXMOA-14162 (#3058)
- adding final operand for dec release (#3064)
