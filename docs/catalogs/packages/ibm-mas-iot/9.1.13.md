...
IBM Maximo IoT v9.1.13
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Update operators.yaml and added new version of orgmgmt includ… (#1249)
- update operators.yaml for dsc (#1289)
- update operators.yaml (#1293)
- update operators.yaml (#1298)
- pick up provision with correct env variable name for 91 (#1301)
- update makefile build case bundle (#1303)
