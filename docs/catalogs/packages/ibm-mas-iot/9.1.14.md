...
IBM Maximo IoT v9.1.14
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Swagger issue fix in webui operator (#1309)
- Update edconfig server for 9.1x (#1328)
- Update edconfig server for 9.1x (#1332)
- use mfgx with corrected msproxy (#1337)
- Update operators.yaml with new fpl version (#1341)
- use mfgx with updated msproxy (#1345)
- pick up fix for post-install-verify failures (#1350)
