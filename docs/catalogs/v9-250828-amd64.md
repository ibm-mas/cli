...
- Customers are advised not to use the catalog `v9-250828` for AIService due to an issue with AIService `9.1.5`.
  Please use the 2nd Sep catalog `v9-250902` with AIService `9.1.6`.
