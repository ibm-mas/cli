...
IBM Maximo Location Service for Esri v9.2.2
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- upgrade ansible-operator to 9.3.16 and mas-utils to 7.37.13 (#489)
- Use per-image tags from Esri 12.0.x manifest to reduce CVE vulnerabilities (#497)
