...
class InstallApp(BaseApp, InstallSettingsMixin, InstallSummarizerMixin, ConfigGeneratorMixin):
    ...
    def aibrokerSettings(self) -> None:
            ...
            if self.yesOrNo("Include IBM Maximo AI Broker"):
                ...
                self.promptForString("storage_accesskey", "mas_aibroker_storage_accesskey")
                self.promptForString("storage_secretkey", "mas_aibroker_storage_secretkey")
                ...
                self.promptForString("watsonxai_apikey", "mas_aibroker_watsonxai_apikey")
                ...
                self.promptForString("secret_value", "mas_aibroker_db_secret_value")
