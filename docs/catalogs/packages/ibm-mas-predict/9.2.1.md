...
IBM Maximo Predict v9.2.1
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- update kyverno policies for 92 predict (#1540)
- add subscription role for applying essential role to coreapi and internalapi (#1542)
- support manualRouteMgmt to disable automatic route creation (#1543)
- Add operand version for july 9.2 patch (#1549)
