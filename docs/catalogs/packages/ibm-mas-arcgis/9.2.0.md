...
IBM Maximo Location Service for Esri v9.2.0
================================================================================

Release Notes
--------------------------------------------------------------------------------
### New Features
- bump up minor for 9.2.0 (#247)
### Bug Fixes and Security Updates
- update mas-utils version (#244)
- Add backport version branche to Whitesource configuration (#249)
- Fix Makefile for non-arch specific builds [9.2.x] (#286)
- update masutils (#342)
- Migrate ArcGIS Enterprise from 11.5 to 12.0 : MASCORE-12370 (#361)
- Generate CRD schemas configmap (#416)
- Add Support for Issuer and Essential Role Installation [MASR-7511] (#430)
- update base images as renovate is disbaled (#442)
- update base image (#447)
- Update license for v9.2 (#448)
