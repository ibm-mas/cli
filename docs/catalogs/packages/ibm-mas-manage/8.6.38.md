...
IBM Maximo Manage v8.6.38
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Updated the ansible-operator version to 9.1.17 and scripts to support latest K8s.client ansible collection (#3438)
- set mxe.mail.oauth.clientName sys property from operator: 86x (#3490)
- Reverted the base image update(ansible-operator from 9.1.20 to 9.1.19) (#3530)
