...
IBM Maximo Manage v9.0.26
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- [skip s390x] Operand container image updates (#3606)
- Hardcoded cryptography v46 for UBI8 compatibility and added script to download prebuilt wheels for ibm-mas-manage-webhook image (#3615)
- updated final operand for may release and pre-commit-config.yaml (#3692)
