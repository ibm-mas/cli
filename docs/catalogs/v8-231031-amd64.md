IBM Maximo Operator Catalog v8 (231031)
===============================================================================
...
<table>
  ...
  <tr><td>Digest</td><td>sha256:TBC</tr></tr>
</table>

!!! important
    On (date TBD) we re-issued this catalog with an updated channel graph that resolves DTXXXXXXX (with link).  This update resolves an edge condition impacting disconnected installations where an intermediate version was required to update from certain versions.
    ...
    MAS CLI versions newer than (TBD) will automatically use this new issue.
...
spec:
  ...
  sourceType: grpc
  image: icr.io/cpopen/ibm-maximo-operator-catalog@sha256:709606362f60456afdb117606dafecc3133118de42d26236f9f2c8bbdcc7721f
  priority: 90
```
