...
IBM Maximo Manage v9.0.27
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- update base images and internal python dependencies(9.0.x) (#3624)
- Updated supported-version-matrix and default-health.yml for June patch (#3763)
