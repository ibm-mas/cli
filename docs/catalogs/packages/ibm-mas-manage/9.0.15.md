...
IBM Maximo Manage v9.0.15
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Corrected debugMode condition (#2523)
- command change to copy default jms config (#2531)
- Initial update for 1 DCUT for July patch 9.0.15 (#2556)
- Add addon placeholders for 9.0.15 release (#2560)
- Updated the latest version of base and civil (#2565)
- corrected the civil version in operator build (#2571)
- Removed clears old keys if re-encryption fails block (9.0.x) (#2583)
- comment out debug block and improve output message for maxinst/updateDb timeout (#2566)
- Updated slackproxy version in operators.yaml (#2601)
- update landing page link (#2597)
- Updated the latest version of manageadmin and health (#2618)
- final image version for 9.0.15 release (#2629)
