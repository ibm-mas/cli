...
<table>
  ...
  <tr><td>Digest</td><td>sha256:d2ffdec7d99dd4b0027d151b36b08b97efd58a1203bd0874fe782ad497198419</tr></tr>
</table>
...
spec:
  ...
  sourceType: grpc
  image: icr.io/cpopen/ibm-maximo-operator-catalog@sha256:d2ffdec7d99dd4b0027d151b36b08b97efd58a1203bd0874fe782ad497198419
  priority: 90
```
...
|--------------------------|-------------------|---------------|-------------------------------------------------------------------------------------|
| ibm-mas                  | 9.0.x             | 9.1.x-issue-MASCORE-5711 | [9.1.0-pre.stable-8193](packages/ibm-mas/9.1.0-pre.stable-8193.md)                  |
|                          |                   | 9.0.x         | [9.0.9](packages/ibm-mas/9.0.9.md)                                                  |
|                          |                   | 8.11.x        | [8.11.20](packages/ibm-mas/8.11.20.md)                                              |
|                          |                   | 8.10.x        | [8.10.23](packages/ibm-mas/8.10.23.md)                                              |
...
| ibm-mas-iot              | 9.0.x             | 9.0.x         | [9.0.6](packages/ibm-mas-iot/9.0.6.md)                                              |
|                          |                   | 8.8.x         | [8.8.16](packages/ibm-mas-iot/8.8.16.md)                                            |
|                          |                   | 8.7.x         | [8.7.20](packages/ibm-mas-iot/8.7.20.md)                                            |
| ibm-mas-manage           | 9.0.x             | 9.1.x-issue-MASCORE-5711 | [9.1.0-pre.stable-9992](packages/ibm-mas-manage/9.1.0-pre.stable-9992.md)           |
|                          |                   | 9.0.x         | [9.0.10](packages/ibm-mas-manage/9.0.10.md)                                         |
|                          |                   | 8.7.x         | [8.7.17](packages/ibm-mas-manage/8.7.17.md)                                         |
|                          |                   | 8.6.x         | [8.6.23](packages/ibm-mas-manage/8.6.23.md)                                         |
| ibm-mas-monitor          | 9.0.x             | 9.0.x         | [9.0.7](packages/ibm-mas-monitor/9.0.7.md)                                          |
|                          |                   | 8.11.x        | [8.11.15](packages/ibm-mas-monitor/8.11.15.md)                                      |
|                          |                   | 8.10.x        | [8.10.17](packages/ibm-mas-monitor/8.10.17.md)                                      |
| ibm-mas-optimizer        | 9.0.x             | 9.1.x-issue-MASCORE-5711 | [9.1.0-pre.stable-1813](packages/ibm-mas-optimizer/9.1.0-pre.stable-1813.md)        |
|                          |                   | 9.0.x         | [9.0.8](packages/ibm-mas-optimizer/9.0.8.md)                                        |
|                          |                   | 8.5.x         | [8.5.14](packages/ibm-mas-optimizer/8.5.14.md)                                      |
|                          |                   | 8.4.x         | [8.4.15](packages/ibm-mas-optimizer/8.4.15.md)                                      |
| ibm-mas-predict          | 9.0.x             | 9.0.x         | [9.0.5](packages/ibm-mas-predict/9.0.5.md)                                          |
|                          |                   | 8.9.x         | [8.9.8](packages/ibm-mas-predict/8.9.8.md)                                          |
|                          |                   | 8.8.x         | [8.8.6](packages/ibm-mas-predict/8.8.6.md)                                          |
| ibm-mas-visualinspection | 9.0.x             | 9.1.x-issue-MASCORE-5711 | [9.1.0-pre.stable-2246](packages/ibm-mas-visualinspection/9.1.0-pre.stable-2246.md) |
|                          |                   | 9.0.x         | [9.0.7](packages/ibm-mas-visualinspection/9.0.7.md)                                 |
|                          |                   | 8.9.x         | [8.9.10](packages/ibm-mas-visualinspection/8.9.10.md)                               |
|                          |                   | 8.8.x         | [8.8.4](packages/ibm-mas-visualinspection/8.8.4.md)                                 |

### IBM Utilities
| Package             | Default Channel   | Channel   | Latest Version                                   |
|---------------------|-------------------|-----------|--------------------------------------------------|
| ibm-data-dictionary | 1.1.x             | 1.1.x     | [1.1.16](packages/ibm-data-dictionary/1.1.16.md) |
