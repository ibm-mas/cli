...
IBM Maximo Manage v9.0.16
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- 90x added api for readiness and startup probe in bundle [MASISMIG-62303] (#2641)
- Updated the latest version of icd(maximo-it) from 9.0.28 to 9.0.29 (#2670)
- MASISMIG-66412 - DT445779 - Installing Manage 8.7.x fails with BuildDataInterpreters (BDI) CRD schema validation (#2635)
- increase gunicorn timeout to 120 sec [MASISMIG-67041] (#2698)
- Updated the latest manageadmin image (#2706)
- increased gunicorn timeout to 150 [MASISMIG-67041] (#2707)
- adding final image for the 9.0.16 aug release (#2716)
