...
IBM Maximo Manage v8.7.22
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Inital update for 1st DCUT for July release 8.7.22 (#2555)
- Updated the addonversion dependendency for aviation and civil (#2572)
- Downgrade the sp from 8.1.16 to 8.1.15 (#2579)
- Removed clears old keys if re-encryption fails block (8.7.x) (#2582)
- comment out debug block and improve output message for maxinst/updateDb timeout (#2568)
- update landing page link (#2598)
- backported MASISMIG-54150 changes to 87x [MAXMF-2751] (#2594)
