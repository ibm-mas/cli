...
IBM Maximo Application Suite v8.10.37
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- mobileapi update to update navigator and it's graphite version to v2.11.449 (#4808)
- fix kafka certs 810x (#4793)
- Fix CORS Misconfiguration Issue in coreapi by Escaping Dot in DOMAIN_NAME (#4847)
- guard against undefined config.oauthAuthentication (#4754)
- Security Fixes for Mend Issues (#4838)
- mobileapi update to update navigator and it's graphite version (#4892)
- security fix for axios - maint10 (#4941)
