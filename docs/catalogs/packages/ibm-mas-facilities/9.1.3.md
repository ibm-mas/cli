...
IBM Maximo Real Estate and Facilities v9.1.3
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Added Makefile for ibm-mas-facilities operator build - 9.1 (#251)
- Promote platform 402070 to maint91xdev (#252)
- Updated README.md with SPS build status - 9.1 (#253)
- Added 9.2 Release Build Status and Branches in README.md - 9.1 (#258)
- Added empty molecule-test target in Makefile - 91x (#266)
- Promote platform 402144 to maint91xdev (#264)
- Promote platform 402146 to maint91xdev (#268)
- Promote platform 402158 to maint91xdev (#269)
- added new NOTICES and NON_IBM_LICENSE (#270)
- added new codeowner (#273)
- Promote release candidate 9.1.3_402158 to 9.1.3 for GA (#272)
