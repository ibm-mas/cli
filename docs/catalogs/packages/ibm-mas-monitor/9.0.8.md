...
IBM Maximo Monitor v9.0.8
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Add API rate limit annotation for all monitor routes (#1006)
- MASMON-2617 resource optimization (#1074)
- updated pipeline version (#1092)
- piplib update (#1098)
- refresh pipelie image number (#1100)
