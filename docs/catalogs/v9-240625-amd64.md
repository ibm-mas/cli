...
<table>
  ...
  <tr><td>Tag</td><td>v9-240625-amd64</tr></tr>
  <tr><td>Digest</td><td>sha256:e74f646327e728aa523199e9dfb2e95efb67385755c3ac9f0763ab6563e63843</tr></tr>
</table>

!!! important
    Maximo Predict users upgrading to cloud pak for data v4.8.0 requires retraining for some model.
    Please refer [here](https://www.ibm.com/docs/en/mas-cd/mhmpmh-and-p-u/continuous-delivery?topic=ui-upgrade-cloud-pak-data-requires-retraining-some-models-maximo-predict)

What's New
-------------------------------------------------------------------------------
- IBM Maximo Application Suite v9.0
- Support for Cloud Pak for Data v4.8.0
- **Security updates and bug fixes**
    ...
    - IBM Data Dictionary 1.1.9
    - IBM Truststore Manager 1.5.4
    - Security updates in base image and python modules

Manual Installation
-------------------------------------------------------------------------------
`oc apply -f https://raw.githubusercontent.com/ibm-mas/cli/master/catalogs/v9-240625-amd64.yaml`
...
spec:
  ...
  sourceType: grpc
  image: icr.io/cpopen/ibm-maximo-operator-catalog@sha256:e74f646327e728aa523199e9dfb2e95efb67385755c3ac9f0763ab6563e63843
  priority: 90
```
...
<table class="compatabilityMatrix">
  ...
  <tr> <td class="firstColumn" rowspan="1">4.12</td><td>4.8.0</td>            <td>February, 2023</td>    <td>February, 2024</td> <td>8.9 - 8.11</td> </tr>
</table>
