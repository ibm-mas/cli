...
IBM Maximo Real Estate and Facilities v9.1.14
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- multiple backport fixes for Platform with build 9100023 (#615)
- Fix contains for the login issue on FIPS env (#617)
- multiple backport fixed for Platform with build 9100028 (#619)
- Changes for ubi9 base image (#623)
- changes for MASREF-6345 regrssion fix (#629)
- promote release candidate 9.1.14_9100030 to 9.1.14 GA (#631)
