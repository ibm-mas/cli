...
IBM Maximo Application Suite v8.11.25
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Fix for Labels & update of Graphite to v2.12.445 (#4008)
- Fix for Labels & update of Graphite to v2.12.448 (#4066)
- Add new environment variable LOG_LEVEL 811x (#4048)
- upgrade coreidplogin to latest (#4086)
- update coreapi image for PackageManifest for 811 version (#4097)
