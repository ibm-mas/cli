...
IBM Maximo Location Service for Esri v9.0.13
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- upgrade ansible-operator to 9.3.16 and mas-utils to 7.37.13 (#491)
- Use per-image tags from Esri 12.0.x manifest to reduce CVE vulnerabilities (#498)
