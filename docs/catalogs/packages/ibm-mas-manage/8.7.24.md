...
IBM Maximo Manage v8.7.24
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- initial update for sept release (#2730)
- 87x fixed ca cert for routes [MASISMIG-67638] (#2757)
- Updated manageadmin image manually (#2772)
- Manage APP CRD is missing spec components - Patch 8.11.x DT448611 (#2778)
