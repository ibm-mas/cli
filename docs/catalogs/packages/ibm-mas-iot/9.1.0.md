...
IBM Maximo IoT v9.1.0
================================================================================

Release Notes
--------------------------------------------------------------------------------
### New Features
- create the 9.1 IoT release ready for rollback merge (#532)
- MASR-127 - OM 3.3: In-Operator Rollback (ibm-mas-iot) (#514)
### Bug Fixes and Security Updates
- Update mas-utils to v7.18.4 (#531)
- IOT 9.1 is compatibile with MAS 9.1 onwards (#534)
- IBMIOT-656 Update license files for FT (#538)
- upgrade datapower (#554)
- Update IoT to Java 17 (#559)
- update mbgx to Java 17 (#566)
- IBMIOT-737 Fix the ContainerLivenessOverLongInitialDelaySeconds in auth (#572)
- IBMIOT-762 - Fix for primary entity manager operator doesn't started in IoT upgrade (#576)
- remove unsupported rollback versions (#578)
- Update EDC operator (#598)
- Update edgeconfig operator (#600)
- update monagent-iot (#603)
- Update all components (in particular with fixes for IBMIOT-799) (#614)
- update monagentiot version dev (#619)
- ansible-operator-iot upgrade to latest (#620)
- IBMIOT-806 Update Services and Requirements (#634)
- Update state to address security fix (#638)
- IBMIOT-821 Update Operators and Service Versions to Latest (#678)
- Update License file for 9.1 Release (#685)
- Updated namespace for primary entity manager (#686)
