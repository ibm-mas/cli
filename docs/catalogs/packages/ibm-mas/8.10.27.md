...
IBM Maximo Application Suite v8.10.27
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Remove hardcoded creds in Molecule (#3726)
- Fix for Labels & update of Graphite to v2.11.426 for MAS810 Navigator-App (#3903)
- Fix for Labels & update of Graphite to v2.11.427 for MAS810 Navigator-App (#3946)
- removed issuer from groups 810x (#3985)
- update kubectl 4.0.16: 810 (#4000)
