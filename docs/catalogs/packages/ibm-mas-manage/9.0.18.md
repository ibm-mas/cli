...
IBM Maximo Manage v9.0.18
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Server bundle pods not created if pre base image version used (9.0.x) (#2812)
- mxe system properties added into non system properties secret fix (9.0.x) (#2814)
- Added missing fields into crds for podTemplates (9.0.x) (#2816)
- Expose system information as environment variable (9.0.x) (#2796)
- Added new field into crds for readonly root file system (9.0.x) (#2858)
- added spatial fixes (#2873)
- Reverted back CRD changes for podTemplates.. (#2878)
