...
IBM Cognos Analytics Service v22.1.0
================================================================================
...
| ca.cpd.ibm.com                           | caservices                               | apply, create, delete, edit, get, list, patch, update, watch                     |
| ca.cpd.ibm.com                           | caservices/status                        | apply, create, delete, edit, get, list, patch, update, watch                     |
| ca.cpd.ibm.com                           | caservices/finalizers                    | apply, create, delete, edit, get, list, patch, update, watch                     |
| ca.cpd.ibm.com                           | caserviceinstances                       | apply, create, delete, edit, get, list, patch, update, watch                     |
| ca.cpd.ibm.com                           | caserviceinstances/status                | apply, create, delete, edit, get, list, patch, update, watch                     |
| ca.cpd.ibm.com                           | caserviceinstances/finalizers            | apply, create, delete, edit, get, list, patch, update, watch                     |
