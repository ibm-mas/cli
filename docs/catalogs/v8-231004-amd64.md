...
spec:
  ...
  sourceType: grpc
  image: icr.io/cpopen/ibm-maximo-operator-catalog@sha256:TBD
  priority: 90
```
...
|                          |                   | 8.11.x    | 8.11.1           |
|                          |                   | 8.9.x     | 8.9.10           |
| ibm-mas-assist           | 8.8.x             | 8.8.x     | 8.8.0            |
|                          |                   | 8.7.x     | 8.7.2            |
|                                              | 8.6.x     | 8.6.5            |
| ibm-mas-hputilities      | 8.6.x             | 8.4.x     | 8.4.1            |
|                          |                   | 8.5.x     | 8.5.3            |
|                          |                   | 8.6.x     | 8.6.2            |
| ibm-mas-iot              | 8.8.x             | 8.8.x     | 8.8.0            |
|                          |                   | 8.6.x     | 8.6.9            |
|                          |                   | 8.7.x     | 8.7.4            |
| ibm-mas-manage           | 8.7.x             | 8.7.x     | 8.7.0            |
|                          |                   | 8.5.x     | 8.5.9            |
|                          |                   | 8.6.x     | 8.6.5            |
