...
class UpdateApp(BaseApp):
    ...
    def chooseCatalog(self) -> None:
        ...
        self.printDescription([
            "Select MAS Catalog",
            "  1) Mar 13 2026 Update (MAS 9.1.10, 9.0.22, 8.11.32, &amp; 8.10.35)",
            "  2) Mar 05 2026 Update (MAS 9.1.10, 9.0.22, 8.11.32, &amp; 8.10.35)",
            "  3) Feb 26 2026 Update (MAS 9.1.10, 9.0.21, 8.11.32, &amp; 8.10.35)",
        ])

        catalogOptions = [
            "v9-260313-amd64", "v9-260305-amd64", "v9-260226-amd64",
        ]
