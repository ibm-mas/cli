...
IBM Maximo Manage v8.7.23
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- MASISMIG-66413 - DT445779 - Installing Manage 8.7.x fails with BuildDataInterpreters (BDI) CRD schema validation (#2634)
- Updated the latest manageadmin image (#2705)
- updated manageadmin image (#2709)
