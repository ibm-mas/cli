...
IBM Maximo Application Suite v8.10.28
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Fix for Labels & update of Graphite to v2.11.442 (#4009)
- Fix for Labels & update of Graphite to v2.11.444 (#4065)
- Add new environment variable LOG_LEVEL 810x (#4049)
- rollback to continue using ubi-python - coreapi (#4078)
- Remove unnecessary folder accidentally merged internalapi: 810 (#4079)
- upgrade coreidplogin to latest (#4085)
- revert scimsyncagent to 2.4.212 (810x) (#4098)
