...
IBM Maximo Application Suite v9.0.29
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Update suite image digests for versions 9.0.x (#5285)
- update ansible-operator (#5337)
- Remove Simulated UDS (SUDS) from BAS Cfg operator for 90 (#5364)
- Fix KeyError in digestmgr by removing redundant suds tag (#5373)
- Adopt the new ubi-flask image into coreapi, internalapi and mobileapi (#5393)
- navigator updated to 9.3.65 to fix pod restart loop intermittent issue (#5419)
