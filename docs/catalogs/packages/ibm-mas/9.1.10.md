...
IBM Maximo Application Suite v9.1.10
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- mobileapi update to update navigator and it's graphite version to v3.1.653 (#4598)
- Enforce mandatory flag for AdoptionMetrics inside MAS Catalogs (91x) (#4608)
- mobileapi update to update navigator and it's graphite version to v2.13.656 (#4624)
- mobileapi update to update navigator and it's graphite version to v3.1.667 (#4626)
- Add usage metric opt-out flags for SaaS and On-Prem deployments for 9.1 (#4621)
- Config version update for Feb (#4637)
- update ansible (#4657)
