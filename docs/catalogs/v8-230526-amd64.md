...
### Certified Operators
The CatalogSource must be named `certified-operators`:
...
### Community Operators
The CatalogSource must be named `community-operators`:
...
### Red Hat Operators
The CatalogSource must be named `redhat-operators`:
