IBM Maximo Operator Catalog v9 (260318)
===============================================================================
...
|--------------------------|-------------------|---------------|---------------------------------------------------------------------------------------|
| ibm-aiservice            | 9.1.x             | 9.2.x-feature | [9.2.0-pre.stable-12908](packages/ibm-aiservice/9.2.0-pre.stable-12908.md)            |
|                          |                   | 9.1.x         | [9.1.12](packages/ibm-aiservice/9.1.12.md)                                            |
| ibm-mas                  | 9.1.x             | 9.2.x-feature | [9.2.0-pre.stable-12926](packages/ibm-mas/9.2.0-pre.stable-12926.md)                  |
|                          |                   | 9.1.x         | [9.1.13](packages/ibm-mas/9.1.13.md)                                                  |
|                          |                   | 9.0.x         | [9.0.22](packages/ibm-mas/9.0.22.md)                                                  |
|                          |                   | 8.11.x        | [8.11.32](packages/ibm-mas/8.11.32.md)                                                |
|                          |                   | 8.10.x        | [8.10.35](packages/ibm-mas/8.10.35.md)                                                |
| ibm-mas-aibroker         | 9.1.x             | 9.1.x         | [9.1.4](packages/ibm-mas-aibroker/9.1.4.md)                                           |
|                          |                   | 9.0.x         | [9.0.6](packages/ibm-mas-aibroker/9.0.6.md)                                           |
| ibm-mas-arcgis           | 9.1.x             | 9.1.x         | [9.1.6](packages/ibm-mas-arcgis/9.1.6.md)                                             |
|                          |                   | 9.0.x         | [9.0.7](packages/ibm-mas-arcgis/9.0.7.md)                                             |
| ibm-mas-assist           | 9.1.x             | 9.1.x         | [9.1.8](packages/ibm-mas-assist/9.1.8.md)                                             |
|                          |                   | 9.0.x         | [9.0.14](packages/ibm-mas-assist/9.0.14.md)                                           |
|                          |                   | 8.8.x         | [8.8.7](packages/ibm-mas-assist/8.8.7.md)                                             |
|                          |                   | 8.7.x         | [8.7.8](packages/ibm-mas-assist/8.7.8.md)                                             |
| ibm-mas-facilities       | 9.1.x             | 9.1.x         | [9.1.8](packages/ibm-mas-facilities/9.1.8.md)                                         |
| ibm-mas-hputilities      | 8.6.x             | 8.6.x         | [8.6.7](packages/ibm-mas-hputilities/8.6.7.md)                                        |
| ibm-mas-iot              | 9.1.x             | 9.1.x         | [9.1.8](packages/ibm-mas-iot/9.1.8.md)                                                |
|                          |                   | 9.0.x         | [9.0.17](packages/ibm-mas-iot/9.0.17.md)                                              |
|                          |                   | 8.8.x         | [8.8.28](packages/ibm-mas-iot/8.8.28.md)                                              |
|                          |                   | 8.7.x         | [8.7.31](packages/ibm-mas-iot/8.7.31.md)                                              |
| ibm-mas-manage           | 9.1.x             | 9.2.x-feature | [9.2.0-pre.stable-13730](packages/ibm-mas-manage/9.2.0-pre.stable-13730.md)           |
|                          |                   | 9.1.x         | [9.1.14](packages/ibm-mas-manage/9.1.14.md)                                           |
|                          |                   | 9.0.x         | [9.0.23](packages/ibm-mas-manage/9.0.23.md)                                           |
|                          |                   | 8.7.x         | [8.7.30](packages/ibm-mas-manage/8.7.30.md)                                           |
|                          |                   | 8.6.x         | [8.6.36](packages/ibm-mas-manage/8.6.36.md)                                           |
| ibm-mas-monitor          | 9.1.x             | 9.1.x         | [9.1.8](packages/ibm-mas-monitor/9.1.8.md)                                            |
|                          |                   | 9.0.x         | [9.0.18](packages/ibm-mas-monitor/9.0.18.md)                                          |
|                          |                   | 8.11.x        | [8.11.26](packages/ibm-mas-monitor/8.11.26.md)                                        |
|                          |                   | 8.10.x        | [8.10.28](packages/ibm-mas-monitor/8.10.28.md)                                        |
| ibm-mas-optimizer        | 9.1.x             | 9.2.x-feature | [9.2.0-pre.stable-12739](packages/ibm-mas-optimizer/9.2.0-pre.stable-12739.md)        |
|                          |                   | 9.1.x         | [9.1.9](packages/ibm-mas-optimizer/9.1.9.md)                                          |
|                          |                   | 9.0.x         | [9.0.20](packages/ibm-mas-optimizer/9.0.20.md)                                        |
|                          |                   | 8.5.x         | [8.5.26](packages/ibm-mas-optimizer/8.5.26.md)                                        |
|                          |                   | 8.4.x         | [8.4.26](packages/ibm-mas-optimizer/8.4.26.md)                                        |
| ibm-mas-predict          | 9.1.x             | 9.1.x         | [9.1.5](packages/ibm-mas-predict/9.1.5.md)                                            |
|                          |                   | 9.0.x         | [9.0.12](packages/ibm-mas-predict/9.0.12.md)                                          |
|                          |                   | 8.9.x         | [8.9.15](packages/ibm-mas-predict/8.9.15.md)                                          |
|                          |                   | 8.8.x         | [8.8.13](packages/ibm-mas-predict/8.8.13.md)                                          |
...
|                          |                   | 9.0.x         | [9.0.17](packages/ibm-mas-visualinspection/9.0.17.md)                                 |
...
| Package             | Default Channel   | Channel   | Latest Version                                   |
|---------------------|-------------------|-----------|--------------------------------------------------|
| ibm-data-dictionary | 1.1.x             | 1.1.x     | [1.1.22](packages/ibm-data-dictionary/1.1.22.md) |
