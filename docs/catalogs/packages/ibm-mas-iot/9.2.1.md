...
IBM Maximo IoT v9.2.1
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- update mfgx version 9.2.24 (#1262)
- add subscription role for applying essential role to coreapi and internalapi (#1270)
- include manualroutemgmt workspace entity manager (#1261)
- Removing component tests (#1275)
- mfgx operator - Fix for Race Condition (#1277)
- fix regression issue when manualRouteMgmt is false (#1278)
- Updated README.md 9.2.x (#1283)
