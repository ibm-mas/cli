...
IBM Maximo IoT v9.0.22
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Update operators.yaml and added new version of orgmgmt includ… (#1250)
- use updated dsc with reverted operands (#1292)
- update version in operators.yaml file (#1294)
- update operators.yaml (#1299)
- pick up provision with correct env variable name (#1300)
- update Makefile build case bundle (#1302)
