...
IBM Maximo Manage v9.1.14
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- updated final operand images for the March 2026 release (#3389)
- emergency downgrade of kubernetes python MASISMIG-73418 fix dependencies
