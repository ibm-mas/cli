...
IBM Maximo Predict v9.0.8
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- update Settings for correct mime type based on the file extension for MAS9 (#1031)
- update aiexpts version (#1058)
- update release versions for predict for MAS 9.0 (#1065)
