...
!!! warning
    ...
    - Data Reporter Operator (DRO) is supported on Linux® x86_64 and OpenShift Container Platform, major version 4 with any available supported minor version.
...
|--------------------------|-------------------|-----------|------------------|
| ibm-mas                  | 8.8.x             | 8.5.x     | 8.5.2            |
|                          |                   | 8.6.x     | 8.6.4            |
|                          |                   | 8.7.x     | 8.7.3            |
|                          |                   | 8.8.x     | 8.8.0            |
| ibm-mas-assist           | 8.5.x             | 8.2.x     | 8.2.0            |
|                          |                   | 8.3.x     | 8.3.0            |
|                          |                   | 8.4.x     | 8.4.0            |
|                          |                   | 8.5.x     | 8.5.0            |
...
|                          |                   | 8.3.x     | 8.3.1            |
|                          |                   | 8.4.x     | 8.4.0            |
| ibm-mas-iot              | 8.5.x             | 8.4.x     | 8.4.3            |
|                          |                   | 8.5.x     | 8.5.0            |
| ibm-mas-manage           | 8.4.x             | 8.0.x     | 8.0.0            |
|                          |                   | 8.1.x     | 8.1.2            |
|                          |                   | 8.2.x     | 8.2.3            |
|                          |                   | 8.3.x     | 8.3.2            |
|                          |                   | 8.4.x     | 8.4.0            |
...
|                          |                   | 8.1.x     | 8.1.0            |
| ibm-mas-optimizer        | 8.2.x             | 8.2.x     | 8.2.0            |
| ibm-mas-predict          | 8.6.x             | 8.4.x     | 8.4.1            |
|                          |                   | 8.5.x     | 8.5.1            |
|                          |                   | 8.6.x     | 8.6.0            |
| ibm-mas-safety           | 8.3.x             | 8.2.x     | 8.2.2            |
|                          |                   | 8.3.x     | 8.3.0            |
| ibm-mas-visualinspection | 8.6.x             | 8.3.x     | 8.3.0            |
|                          |                   | 8.4.x     | 8.4.0            |
|                          |                   | 8.5.x     | 8.5.0            |
|                          |                   | 8.6.x     | 8.6.0            |
...
| Package                         | Default Channel   | Channel   | Latest Version   |
|---------------------------------|-------------------|-----------|------------------|
| db2u-operator                   | v2.0              | v1.0      | 1.0.9            |
|                                 |                   | v1.1      | 1.1.9            |
|                                 |                   | v2.0      | 2.0.0            |
| ibm-cert-manager-operator       | v3                | beta      | 3.9.0            |
|                                 |                   | v3        | 3.9.0            |
| ibm-common-service-operator     | v3                | beta      | 3.7.1            |
|                                 |                   | v3        | 3.9.0            |
| ibm-events-operator             | v3                | beta      | 3.7.1            |
|                                 |                   | v3        | 4.2.0            |
| ibm-licensing-operator-app      | v3                | beta      | 1.4.1            |
|                                 |                   | v3        | 1.9.0            |
| ibm-namespace-scope-operator    | v3                | beta      | 1.1.1            |
|                                 |                   | v3        | 1.9.0            |
| ibm-odlm                        | v3                | beta      | 1.5.0            |
|                                 |                   | v3        | 1.9.0            |
| ibm-user-data-services-operator | alpha             | alpha     | 2.0.8            |
| ibm-zen-operator                | v3                | beta      | 1.0.1            |
|                                 |                   | v3        | 1.5.4            |
...
| Package                       | Default Channel   | Channel   | Latest Version   |
|-------------------------------|-------------------|-----------|------------------|
| analyticsengine-operator      | v2.0              | beta      | 1.0.1            |
|                               |                   | stable-v1 | 1.0.9            |
|                               |                   | v2.0      | 2.0.0            |
| cpd-platform-operator         | v3.0              | beta      | 2.0.0            |
|                               |                   | stable-v1 | 2.0.0            |
|                               |                   | v2.0      | 2.0.8            |
|                               |                   | v3.0      | 3.0.0            |
| ibm-cpd-ccs                   | v2.0              | v1.0      | 1.0.9            |
|                               |                   | v2.0      | 2.0.0            |
| ibm-cpd-datarefinery          | v2.0              | v1.0      | 1.0.9            |
|                               |                   | v2.0      | 2.0.0            |
| ibm-cpd-wml-operator          | v2.0              | alpha     | 1.1.0            |
|                               |                   | beta      | 1.0.1486         |
|                               |                   | v1.1      | 1.1.8            |
|                               |                   | v2.0      | 2.0.0            |
| ibm-cpd-wos                   | v2.0              | alpha     | 1.2.0            |
|                               |                   | v1        | 1.5.0            |
|                               |                   | v1.5      | 1.5.4            |
|                               |                   | v2.0      | 2.0.0            |
| ibm-cpd-ws-runtimes           | v5.0              | v1.0      | 1.0.9            |
|                               |                   | v5.0      | 5.0.0            |
| ibm-cpd-wsl                   | v3.0              | v2.0      | 2.0.9            |
|                               |                   | v3.0      | 3.0.0            |
| ibm-elasticsearch-operator    | v1.1              | v1.1      | 1.1.969          |
| ibm-etcd-operator             | v1.0              | v1.0      | 1.0.8            |
| ibm-minio-operator            | v1.0              | v1.0      | 1.0.9            |
| ibm-model-train-operator      | v1.1              | v1.1      | 1.1.2            |
| ibm-rabbitmq-operator         | v1.0              | v1.0      | 1.0.9            |
| ibm-watson-discovery-operator | v4.5              | v4.0      | 4.0.9            |
|                               |                   | v4.5      | 4.5.0            |
...
|                  |                   | v2.1      | 2.0.1            |
|                  |                   | v2.2      | 2.2.1            |
| ibm-appconnect   | v5.0-lts          | cd        | 5.0.0            |
|                  |                   | v1.0      | 1.0.5            |
|                  |                   | v1.1-eus  | 1.1.9            |
|                  |                   | v1.2      | 1.2.0            |
|                  |                   | v1.3      | 1.3.2            |
