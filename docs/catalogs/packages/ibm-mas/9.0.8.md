...
IBM Maximo Application Suite v9.0.8
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Fix a security issue where the error_description of a failed login could be tampered with in the URL query parameter (90x) (#3387)
- update mobileapi version (#3395)
- Update Suite CRD to support hostAliases under podTemplates (#3401)
- Update ScimCfg and PushNotificationCfg CRD to support hostAliases under podTemplates (#3404)
- Update SlsCfg and SmtpCfg CRD to support hostAliases under podTemplates (#3407)
- Update BasCfg CRD to support hostAliases under podTemplates (#3410)
- Temporarily disable broken ibm-mas-cfg-idp molecule scenario (#3420)
- add 9.0.7 and 9.11.18 mas suite img digest (#3424)
- Fix the execution order of ibm-mas-cfg-idp molecule tasks (#3426)
