...
<table>
  ...
  <tr><td>Tag</td><td>v9-250206-amd64</tr></tr>
  <tr><td>Digest</td><td>sha256:12ece30673a4109123e43f28a8f2d427bd37186c32d961c0dced8866886a2d4c</tr></tr>
</table>
...
Manual Installation
-------------------------------------------------------------------------------
`oc apply -f https://raw.githubusercontent.com/ibm-mas/cli/master/catalogs/v9-250206-amd64.yaml`
...
spec:
  displayName: IBM Maximo Operators (v9-250206-amd64)
  publisher: IBM
  description: Static Catalog Source for IBM Maximo Application Suite
  sourceType: grpc
  image: icr.io/cpopen/ibm-maximo-operator-catalog@sha256:12ece30673a4109123e43f28a8f2d427bd37186c32d961c0dced8866886a2d4c
  priority: 90
```
...
|--------------------------|-------------------|---------------|-------------------------------------------------------------------------------------|
| ibm-mas                  | 9.0.x             | 9.1.x-issue-MASCORE-5711 | [9.1.0-pre.stable-7790](packages/ibm-mas/9.1.0-pre.stable-7790.md)                  |
|                          |                   | 9.0.x         | [9.0.8](packages/ibm-mas/9.0.8.md)                                                  |
|                          |                   | 8.11.x        | [8.11.19](packages/ibm-mas/8.11.19.md)                                              |
|                          |                   | 8.10.x        | [8.10.22](packages/ibm-mas/8.10.22.md)                                              |
...
| ibm-mas-iot              | 9.0.x             | 9.0.x         | [9.0.5](packages/ibm-mas-iot/9.0.5.md)                                              |
|                          |                   | 8.8.x         | [8.8.15](packages/ibm-mas-iot/8.8.15.md)                                            |
|                          |                   | 8.7.x         | [8.7.19](packages/ibm-mas-iot/8.7.19.md)                                            |
| ibm-mas-manage           | 9.0.x             | 9.1.x-issue-MASCORE-5711 | [9.1.0-pre.stable-9630](packages/ibm-mas-manage/9.1.0-pre.stable-9630.md)           |
|                          |                   | 9.0.x         | [9.0.9](packages/ibm-mas-manage/9.0.9.md)                                           |
|                          |                   | 8.7.x         | [8.7.16](packages/ibm-mas-manage/8.7.16.md)                                         |
|                          |                   | 8.6.x         | [8.6.22](packages/ibm-mas-manage/8.6.22.md)                                         |
| ibm-mas-monitor          | 9.0.x             | 9.0.x         | [9.0.6](packages/ibm-mas-monitor/9.0.6.md)                                          |
|                          |                   | 8.11.x        | [8.11.14](packages/ibm-mas-monitor/8.11.14.md)                                      |
|                          |                   | 8.10.x        | [8.10.16](packages/ibm-mas-monitor/8.10.16.md)                                      |
| ibm-mas-optimizer        | 9.0.x             | 9.1.x-issue-MASCORE-5711 | [9.1.0-pre.stable-1703](packages/ibm-mas-optimizer/9.1.0-pre.stable-1703.md)        |
|                          |                   | 9.0.x         | [9.0.7](packages/ibm-mas-optimizer/9.0.7.md)                                        |
|                          |                   | 8.5.x         | [8.5.13](packages/ibm-mas-optimizer/8.5.13.md)                                      |
|                          |                   | 8.4.x         | [8.4.14](packages/ibm-mas-optimizer/8.4.14.md)                                      |
...
| ibm-mas-visualinspection | 9.0.x             | 9.1.x-issue-MASCORE-5711 | [9.1.0-pre.stable-2122](packages/ibm-mas-visualinspection/9.1.0-pre.stable-2122.md) |
|                          |                   | 9.0.x         | [9.0.6](packages/ibm-mas-visualinspection/9.0.6.md)                                 |
|                          |                   | 8.9.x         | [8.9.9](packages/ibm-mas-visualinspection/8.9.9.md)                                 |
|                          |                   | 8.8.x         | [8.8.4](packages/ibm-mas-visualinspection/8.8.4.md)                                 |

### IBM Utilities
| Package             | Default Channel   | Channel   | Latest Version                                   |
|---------------------|-------------------|-----------|--------------------------------------------------|
| ibm-data-dictionary | 1.1.x             | 1.1.x     | [1.1.15](packages/ibm-data-dictionary/1.1.15.md) |
...
| ibm-cert-manager-operator           | v3.23             | v4.2         | [4.2.11](packages/ibm-cert-manager-operator/4.2.11.md)             |
...
|                                     |                   | v4.6         | [4.6.9](packages/ibm-common-service-operator/4.6.9.md)             |
...
| ibm-commonui-operator-app           | v3.23             | v4.6         | [4.6.0](packages/ibm-commonui-operator-app/4.6.0.md)               |
|                                     |                   | v4.5         | [4.5.2](packages/ibm-commonui-operator-app/4.5.2.md)               |
|                                     |                   | v4.4         | [4.4.8](packages/ibm-commonui-operator-app/4.4.8.md)               |
...
| ibm-licensing-operator-app          | v3.23             | v4.2         | [4.2.11](packages/ibm-licensing-operator-app/4.2.11.md)            |
...
| ibm-namespace-scope-operator        | v3.23             | v4.2         | [4.2.11](packages/ibm-namespace-scope-operator/4.2.11.md)          |
...
| ibm-odlm                            | v3.23             | v4.3         | [4.3.8](packages/ibm-odlm/4.3.8.md)                                |
...
| cpd-platform-operator         | v6.1              | v6.1      | [6.1.0](packages/cpd-platform-operator/6.1.0.md)            |
...
| ibm-ca-operator               | v27.0             | v4.0      | [4.0.8](packages/ibm-ca-operator/4.0.8.md)                  |
...
| ibm-cpd-ccs                   | v10.0             | v9.3      | [9.3.0](packages/ibm-cpd-ccs/9.3.0.md)                      |
...
| ibm-cpd-datarefinery          | v10.0             | v9.3      | [9.3.0](packages/ibm-cpd-datarefinery/9.3.0.md)             |
...
| ibm-cpd-wml-operator          | v7.0              | v7.0      | [7.0.0](packages/ibm-cpd-wml-operator/7.0.0.md)             |
...
| ibm-cpd-wos                   | v7.0              | v7.0      | [7.0.0](packages/ibm-cpd-wos/7.0.0.md)                      |
...
| ibm-cpd-ws-runtimes           | v10.0             | v9.3      | [9.3.0](packages/ibm-cpd-ws-runtimes/9.3.0.md)              |
...
| ibm-cpd-wsl                   | v10.0             | v9.3      | [9.3.0](packages/ibm-cpd-wsl/9.3.0.md)                      |
...
| ibm-elasticsearch-operator    | v1.1              | v1.1      | [1.1.2470](packages/ibm-elasticsearch-operator/1.1.2470.md) |
| ibm-etcd-operator             | v1.0              | v1.0      | [1.0.34](packages/ibm-etcd-operator/1.0.34.md)              |
...
|                               |                   | v4.5      | [4.5.8](packages/ibm-iam-operator/4.5.8.md)                 |
...
| ibm-rabbitmq-operator         | v1.0              | v1.0      | [1.0.33](packages/ibm-rabbitmq-operator/1.0.33.md)          |
| ibm-watson-discovery-operator | v9.0              | v9.0      | [9.0.0](packages/ibm-watson-discovery-operator/9.0.0.md)    |
...
| ibm-appconnect   | v12.7             | v9.2      | 9.2.1                                         |
|                  |                   | v9.1      | 9.1.0                                         |
|                  |                   | v9.0      | 9.0.0                                         |
|                  |                   | v8.2      | 8.2.1                                         |
|                  |                   | v8.1      | 8.1.0                                         |
