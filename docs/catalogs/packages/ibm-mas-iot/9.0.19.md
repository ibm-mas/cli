...
IBM Maximo IoT v9.0.19
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- 90x Update operators.yaml with latest edgeconfig image (#1102)
- Updating mbgx to 5.0.61 (#1150)
- Update operators.yaml to include latest version of edgeconfig (#1155)
