...
IBM Maximo Predict v9.1.4
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- update dummy commit for predict feature channel (#1116)
- merge dev into maint91xdev for predict FC (#1118)
- refresh operator for 9.1 (#1131)
- update pmlib version for 9.1 (#1151)
- update kubectl versions for 9.1 (#1153)
- update pmlib for cpd 5.2 (#1172)
- update file for predict api for 9.1 (#1178)
- update files for filebeat in predict 9.1 (#1170)
- update predict api version for 91 (#1191)
- update release version for 9.1 dec patch (#1195)
- update predict 9.1 to python 3.12 (#1197)
