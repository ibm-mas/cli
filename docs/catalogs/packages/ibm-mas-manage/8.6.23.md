...
IBM Maximo Manage v8.6.23
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- update maxloader ref to current (86x) (#2197)
- Initial DCUT changes for 8.6.23 march release (#2211)
- Health 8.8.13 March 2025 release (#2193)
