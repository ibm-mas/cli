...
| image.openshift.io                       | imagestreamtags                          | create, delete, get, list, patch, update, watch                                  |
| spssmodeler.cpd.ibm.com                  | *                                        | create, delete, get, list, patch, update, watch                                  |
| ws.cpd.ibm.com                           | *                                        | create, delete, get, list, patch, update, watch                                  |
| zen.cpd.ibm.com                          | *                                        | create, delete, get, list, patch, update, watch                                  |
| ccs.cpd.ibm.com                          | *                                        | create, delete, get, list, patch, update, watch                                  |
| datarefinery.cpd.ibm.com                 | *                                        | create, delete, get, list, patch, update, watch                                  |
