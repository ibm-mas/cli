...
IBM Maximo Application Suite v8.11.20
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- update mobileapi version : MAS-811 (#3455)
- Update CoreIDP CRD to support hostAliases under podTemplates (#3449)
- backport CRD updates for MASCORE-5227 811x (#3458)
- update mobileapi version : MAS-811 (#3467)
- Add reconcile period and retry logic on entitymgr-idpcfg (#3364)
- Fix lint error: (maint811xdev) (#3474)
- add fix for LDAP connectivity failure after adding maxLdapRetries - 8.11.x (#3486)
- Fix BAS reconcile configmap namespace - 811 (#3513)
- Add ibm-mas-suite feb release into rollback supported images list (maint811xdev) (#3509)
