...
masArgGroup.add_argument("-i", "--mas-instance-id", dest="mas_instance_id", required=False, help="MAS Instance ID")
...
masArgGroup.add_argument("--mas-version", dest="mas_core_version", required=False, help="Subscription channel for the Core Platform")


masArgGroup.add_argument("--manage-version", dest="mas_app_manage_version", required=False, help="Subscription channel for Maximo Manage")

masArgGroup.add_argument("--iot-version", required=False, dest="mas_app_iot_version", help="Subscription channel for Maximo IoT")
