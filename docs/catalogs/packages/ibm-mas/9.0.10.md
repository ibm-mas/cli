...
IBM Maximo Application Suite v9.0.10
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- update mobileapi version : MAS-90 (#3539)
- MASCORE-5506 - Modify Deployment template to remove unwanted IBM Licensing Service (#3532)
- [MASCORE-5815] suite adoption of OSDK v1.36+ 90x (#3560)
- Fix phone number size limitation 9.0.x (#3565)
- - Remove RHM Catalog Sync Job Infrastructure For Existing Users: 90x (#3571)
- update mobileapi version : MAS-90 (#3591)
- fix log for molecule test resources (#3582)
- fix detect-secrets findings (#3602)
- Sign images for 390x in correct order (90x) (#3595)
- Add 90 prev release into rollback supported images list (90x) (#3615)
- Fix bulk sendmail endpoint to also check for disabled email templates (9.0.x) (#3620)
- mobileapi set PyMongo logging to WARNING MASCORE-6001 90x (#3630)
- fix adoptionusage dashboard for multiple instances (#3641)
