...
IBM Maximo Application Suite v9.1.19
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Reduce CPU throttling in entitymgr-mongocfg (maint91xdev) (#5011)
- mobileapi update to update navigator and it's graphite version (#5137)
- Fix SAML Fips race condition (#5146)
- Restructure Suite CR settings to group metric collection flags for 91 (#5121)
- Update suite image digests for versions 9.0.26, 9.1.17, 9.1.18 (#5142)
- Update mobileapi version for graphite update (#5183)
- sendmail pod restarting every few minutes (#5162)
- ppc64le mas 9.1 x fix (#5168)
- update Config version with June patch version (#5187)
- DT473203 - Fix OIDC client registration job stuck in deletion with finalizers - 9.1.x (#5189)
