...
IBM Maximo Real Estate and Facilities v9.1.11
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Added no_log: true for route creation task - 9.1 (#489)
- added timezone configuration in CRD (#470)
- Generate CRD schemas configmap (91) (#493)
- promoting build 403720 to 91x maintenance (#503)
- Promote release candidate 9.1.11_403720 to 9.1.11 for GA (#505)
