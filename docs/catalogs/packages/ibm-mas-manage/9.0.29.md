...
IBM Maximo Manage v9.0.29
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Corrected server bundle service account (9.0.x) (#3866)
- update internal python dependencies(maint90xdev) (#3903)
- bdi image update (#3953)
- MAXMIS-7795: update imagestitching operator version to 1.1.32 for ubi9 (#3958)
- update cryptography to 50.0.0(maint90xdev) (#3995)
- added healthext 2.0.40 for aug (#4011)
- final operand updated for aug release (#4022)
