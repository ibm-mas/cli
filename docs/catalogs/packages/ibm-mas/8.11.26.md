...
IBM Maximo Application Suite v8.11.26
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Remove secrets data from logs - 811x (#4144)
- Fix for Labels & update of Graphite to v2.12.450 (#4158)
- Configure TLS for monagent-mas and workspace-coordinator probes in 8.11.x (#4132)
- Fix a runtime error in the UI when a certain combination of versions in supportedVersions array in the GET /about API response is returned (811x) (#4179)
