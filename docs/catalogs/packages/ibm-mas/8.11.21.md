...
IBM Maximo Application Suite v8.11.21
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- update mobileapi version : MAS-811 (#3540)
- MASCORE-5506 - Modify Deployment template to remove unwanted IBM Licensing Service (#3534)
- Fix phone number size limitation - 8.11.x (#3563)
- Fix string type for ssoCookieName - 811 (#3452)
- - Remove RHM Catalog Sync Job Infrastructure For Existing Users: 811x (#3556)
- update mobileapi version : MAS-811 (#3589)
- fix log for molecule test resources (#3583)
- fix detect-secrets findings (#3603)
- Add 811x prev release into rollback supported images list (811x) (#3616)
- Fix bulk sendmail endpoint to also check for disabled email templates (8.11.x) (#3619)
- mobileapi set PyMongo logging to WARNING MASCORE-6001 811x (#3631)
