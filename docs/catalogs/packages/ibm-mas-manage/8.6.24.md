...
IBM Maximo Manage v8.6.24
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Updated the manage monitoring openshift version to 4.1.13 (#2216)
- testPrometheusServerLevelMetrics is failing in fvt86x pipeline (#2227)
- Initial DCUT update for March-Apr release 8.6.x (#2236)
- Updated the base image in supported version matrix (#2237)
- update secrets.baseline (#2247)
