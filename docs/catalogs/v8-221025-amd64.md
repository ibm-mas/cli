...
Manual Installation
-------------------------------------------------------------------------------
`oc apply -f https://raw.githubusercontent.com/ibm-mas/cli/master/catalogs/v8-221025-amd64.yml`
...
!!! note
    Changes from previous catalog ([v8-220927-amd64](v8-220927-amd64.md)) are highlighted in **bold**.
...
| ibm-mas-iot              | 8.5.x   | **8.5.2**       |
| ibm-mas-iot              | 8.4.x   | **8.4.5**       |
| ibm-mas-manage           | 8.4.x   | **8.4.2**       |
| ibm-mas-manage           | 8.3.x   | **8.3.5**       |
