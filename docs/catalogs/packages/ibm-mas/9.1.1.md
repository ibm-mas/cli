...
IBM Maximo Application Suite v9.1.1
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Increase addons molecule timeout to fix s390x failure (#3929)
- Using the internal service URL with server CA for OIDC registration and new login error messages during force logout events (#3936)
- add env variable INTERNAL_CERT_MOUNT_PATH in metering job (#3944)
- Fix for Labels & update of Graphite to v3.1.546 (#3969)
- Remove Logo Objects From Accelerator Data Models (#3964)
- App configuration version update (#3975)
- Use kubectl / initContainers with Filebeat (#3939)
- Remove 9.1 FC references in supported-images.yml (#3945)
- After the password change flow of the login page, redirect to the /authorize URL, to make sure the user will end up in the desired logged page instead of MAS homepage (#3988)
- Add support for MONGODB-AWS auth (#3984)
- Add 91x prev release into rollback supported images list (dev) (#3951)
- Add support for MONGODB-AWS auth (follow-on to include all updated images) (#3995)
- Use hasFoundation() instead of isFullManage() from mas-utils-py to set the isManageAvailable flag in uiresesources API response (#4002)
- Update Filebeat command args (#4003)
- updated image versions for admin-dashboard and navigator (#4004)
- Adding default for lang parameter uiresources (#4005)
