...
IBM Maximo Operator Catalog v9 (240827)
===============================================================================
...
<table>
  ...
  <tr><td>Tag</td><td>v9-240827-amd64</tr></tr>
  <tr><td>Digest</td><td>sha256:bcace8fa41d14ce1b818467243bbc8469f7538ac4bc46198139454626f99f367</tr></tr>
  <!-- ^^^^^ tbc -->
</table>
...
Manual Installation
-------------------------------------------------------------------------------
`oc apply -f https://raw.githubusercontent.com/ibm-mas/cli/master/catalogs/v9-240827-amd64.yaml`
...
spec:
  displayName: IBM Maximo Operators (v9-240827-amd64)
  publisher: IBM
  description: Static Catalog Source for IBM Maximo Application Suite
  sourceType: grpc
  image: icr.io/cpopen/ibm-maximo-operator-catalog@sha256:bcace8fa41d14ce1b818467243bbc8469f7538ac4bc46198139454626f99f367
  priority: 90
```
...
|--------------------------|-------------------|-----------|-----------------------------------------------------|
| ibm-mas                  | 9.0.x             | 9.0.x     | [9.0.2](packages/ibm-mas/9.0.2.md)                  |
|                          |                   | 8.11.x    | [8.11.14](packages/ibm-mas/8.11.14.md)              |
|                          |                   | 8.10.x    | [8.10.17](packages/ibm-mas/8.10.17.md)              |
| ibm-mas-aibroker         | 9.0.x             | 9.0.x     | [9.0.1](packages/ibm-mas-aibroker/9.0.1.md)         |
...
| ibm-mas-iot              | 9.0.x             | 9.0.x     | [9.0.2](packages/ibm-mas-iot/9.0.2.md)              |
|                          |                   | 8.8.x     | [8.8.12](packages/ibm-mas-iot/8.8.12.md)            |
|                          |                   | 8.7.x     | [8.7.16](packages/ibm-mas-iot/8.7.16.md)            |
| ibm-mas-manage           | 9.0.x             | 9.0.x     | [9.0.2](packages/ibm-mas-manage/9.0.2.md)           |
|                          |                   | 8.7.x     | [8.7.11](packages/ibm-mas-manage/8.7.11.md)         |
|                          |                   | 8.6.x     | [8.6.17](packages/ibm-mas-manage/8.6.17.md)         |
| ibm-mas-monitor          | 9.0.x             | 9.0.x     | [9.0.2](packages/ibm-mas-monitor/9.0.2.md)          |
|                          |                   | 8.11.x    | [8.11.10](packages/ibm-mas-monitor/8.11.10.md)      |
|                          |                   | 8.10.x    | [8.10.13](packages/ibm-mas-monitor/8.10.13.md)      |
| ibm-mas-optimizer        | 9.0.x             | 9.0.x     | [9.0.2](packages/ibm-mas-optimizer/9.0.2.md)        |
|                          |                   | 8.5.x     | 8.5.8                                               |
|                          |                   | 8.4.x     | [8.4.9](packages/ibm-mas-optimizer/8.4.9.md)        |
| ibm-mas-predict          | 9.0.x             | 9.0.x     | [9.0.1](packages/ibm-mas-predict/9.0.1.md)          |
|                          |                   | 8.9.x     | [8.9.3](packages/ibm-mas-predict/8.9.3.md)          |
|                          |                   | 8.8.x     | [8.8.3](packages/ibm-mas-predict/8.8.3.md)          |
| ibm-mas-visualinspection | 9.0.x             | 9.0.x     | [9.0.2](packages/ibm-mas-visualinspection/9.0.2.md) |
|                          |                   | 8.9.x     | [8.9.5](packages/ibm-mas-visualinspection/8.9.5.md) |
|                          |                   | 8.8.x     | [8.8.4](packages/ibm-mas-visualinspection/8.8.4.md) |

### IBM Utilities
| Package             | Default Channel   | Channel   | Latest Version                                   |
|---------------------|-------------------|-----------|--------------------------------------------------|
| ibm-data-dictionary | 1.1.x             | 1.1.x     | [1.1.11](packages/ibm-data-dictionary/1.1.11.md) |
| ibm-sls             | 3.x               | 3.x       | [3.10.0](packages/ibm-sls/3.10.0.md)             |
...
| ibm-cert-manager-operator           | v3.23             | v4.2         | [4.2.4](packages/ibm-cert-manager-operator/4.2.4.md)               |
...
| ibm-common-service-operator         | v3.23             | v4.7         | [4.7.0](packages/ibm-common-service-operator/4.7.0.md)             |
|                                     |                   | v4.6         | [4.6.3](packages/ibm-common-service-operator/4.6.3.md)             |
...
| ibm-commonui-operator-app           | v3.23             | v4.4         | [4.4.1](packages/ibm-commonui-operator-app/4.4.1.md)               |
...
| ibm-licensing-operator-app          | v3.23             | v4.2         | [4.2.4](packages/ibm-licensing-operator-app/4.2.4.md)              |
...
| ibm-namespace-scope-operator        | v3.23             | v4.2         | [4.2.5](packages/ibm-namespace-scope-operator/4.2.5.md)            |
...
| ibm-odlm                            | v3.23             | v4.3         | [4.3.2](packages/ibm-odlm/4.3.2.md)                                |
...
| ibm-zen-operator                    | v3.23             | v6.0         | [6.0.1](packages/ibm-zen-operator/6.0.1.md)                        |
|                                     |                   | v4.4         | [5.1.5](packages/ibm-zen-operator/5.1.5.md)                        |
...
| isf-operator                        | v2.0              | v2.0         | [2.8.0](packages/isf-operator/2.8.0.md)                            |

### IBM Cloud Pak for Data
| Package                       | Default Channel   | Channel   | Latest Version                                              |
|-------------------------------|-------------------|-----------|-------------------------------------------------------------|
| analyticsengine-operator      | v5.4              | v5.4      | [5.4.0](packages/analyticsengine-operator/5.4.0.md)         |
...
| cpd-platform-operator         | v6.0              | v6.0      | [6.0.0](packages/cpd-platform-operator/6.0.0.md)            |
...
| ibm-ca-operator               | v26.0             | v4.0      | [4.0.8](packages/ibm-ca-operator/4.0.8.md)                  |
...
| ibm-cpd-ccs                   | v9.0              | v9.0      | [9.0.0](packages/ibm-cpd-ccs/9.0.0.md)                      |
...
| ibm-cpd-datarefinery          | v9.0              | v9.0      | [9.0.0](packages/ibm-cpd-datarefinery/9.0.0.md)             |
...
| ibm-cpd-wml-operator          | v6.0              | v6.0      | [6.0.0](packages/ibm-cpd-wml-operator/6.0.0.md)             |
...
| ibm-cpd-wos                   | v6.0              | v6.0      | [6.0.0](packages/ibm-cpd-wos/6.0.0.md)                      |
...
| ibm-cpd-ws-runtimes           | v9.0              | v9.0      | [9.0.0](packages/ibm-cpd-ws-runtimes/9.0.0.md)              |
...
| ibm-cpd-wsl                   | v9.0              | v9.0      | [9.0.0](packages/ibm-cpd-wsl/9.0.0.md)                      |
...
| ibm-elasticsearch-operator    | v1.1              | v1.1      | [1.1.2153](packages/ibm-elasticsearch-operator/1.1.2153.md) |
| ibm-etcd-operator             | v1.0              | v1.0      | [1.0.27](packages/ibm-etcd-operator/1.0.27.md)              |
| ibm-iam-operator              | v3.23             | v4.5      | [4.5.1](packages/ibm-iam-operator/4.5.1.md)                 |
...
| ibm-rabbitmq-operator         | v1.0              | v1.0      | [1.0.27](packages/ibm-rabbitmq-operator/1.0.27.md)          |
| ibm-watson-discovery-operator | v8.0              | v8.0      | [8.0.0](packages/ibm-watson-discovery-operator/8.0.0.md)    |
...
|               |                   | v110509.0 | [110509.0.1](packages/db2u-operator/110509.0.1.md) |
...
| ibm-appconnect   | v12.1             | v9.2      | 9.2.1                                         |
|                  |                   | v9.1      | 9.1.0                                         |
|                  |                   | v9.0      | 9.0.0                                         |
|                  |                   | v8.2      | 8.2.1                                         |
|                  |                   | v8.1      | 8.1.0                                         |
...
| Package                | Default Channel   | Channel   | Latest Version                                    |
|------------------------|-------------------|-----------|---------------------------------------------------|
| eclipse-amlen-operator | 1.x               | 1.x       | [1.1.1](packages/eclipse-amlen-operator/1.1.1.md) |
