...
IBM Maximo Application Suite v9.1.11
================================================================================

Release Notes
--------------------------------------------------------------------------------
### Bug Fixes and Security Updates
- Reorder the sequence in which we fetch the wheels (#4442)
- add Maximo IT valuemetrics 91x (#4694)
- data-stream file for oscap scanning (#4266)
- mobileapi update to update navigator and it's graphite version to v3.1.671 (#4690)
- mascore-11749 Add index for applications - 9.1.x (#4594)
- fix icd validation issue 91x (#4717)
- mobileapi update to update navigator and it's graphite version to v3.1.679 (#4720)
- March config version with graphite version (#4723)
- Backport only the Suite CRD changes with the new mobile quick setup configuration to 9.1 (#4741)
- create countrycodes configmap to support PI compliance 91x (#4636)
- security fix for axios, lodash, lodash-es and qs - 9.1 (#4740)
- address kubernetes no_proxy issue MASISMIG-73418 (#4759)
