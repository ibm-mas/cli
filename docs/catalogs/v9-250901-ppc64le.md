...
<table>
  ...
  <tr><td>Tag</td><td>v9-250901-ppc64le</tr></tr>
...
Manual Installation
-------------------------------------------------------------------------------
`oc apply -f https://raw.githubusercontent.com/ibm-mas/cli/master/catalogs/v9-250901-ppc64le.yaml`
...
spec:
  displayName: IBM Maximo Operators (v9-250901-ppc64le)
  publisher: IBM
